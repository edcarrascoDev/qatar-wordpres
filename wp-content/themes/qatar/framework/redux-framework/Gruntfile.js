...
module.exports = function(grunt) {
            ...
            travis: {
                options: {
                    repo:
                        ...
                        '@github.com/ReduxFramework/docs.reduxframework.com.git',
                    user: {
                        name: 'Travis',
                ...
                files: [
                    {
                        ...
                        src: [
                            '**/*.js',
                            '!**/*.min.js',
                            '!ace_editor/vendor/*.js',
                            '!ace_editor/vendor/snippets/*.js',
        ...
        sass: {
            ...
            admin: {
                ...
                files: {
                    ...
                    'ReduxCore/assets/css/rtl.css': ['ReduxCore/assets/css/rtl.scss'],
                },
            },
            welcome: {
                options: {
    ...
    grunt.registerTask('langUpdate', ['addtextdomain', 'makepot', 'shell:txpull', 'potomo']);
