    ...
    (function(factory) {
        ...
        PROTOTYPE.reposition = function(event, effect) {
            ...
            // Check if mouse was the target
                ...
                if (
                    doc.body.offsetWidth !== (window.innerWidth || doc.documentElement.clientWidth)
                ) {
            ...
            // Target wasn't mouse or absolute...
                ...
                if (
                    ...
                    position.left +=
                        at.x === RIGHT ? targetWidth : at.x === CENTER ? targetWidth / 2 : 0;
                    position.top +=
                        at.y === BOTTOM ? targetHeight : at.y === CENTER ? targetHeight / 2 : 0;
                }
            }
            ...
            position.left +=
                adjust.x +
                (my.x === RIGHT ? -tooltipWidth : my.x === CENTER ? -tooltipWidth / 2 : 0);
            position.top +=
                adjust.y +
                (my.y === BOTTOM ? -tooltipHeight : my.y === CENTER ? -tooltipHeight / 2 : 0);
        ...
        PROTOTYPE._assignEvents = function() {
            ...
            if (('' + options.hide.event).indexOf('unfocus') > -1) {
                this._bind(containerTarget.closest('html'), ['mousedown', 'touchstart'], function(
                    event,
                ) {
        ...
        $.extend(Tip.prototype, {
            ...
            _invalidColour: function(elem, prop, compare) {
                ...
                return !val || (compare && val === elem.css(compare)) || INVALID.test(val)
                    ? FALSE
                    : val;
            },
            ...
            update: function(corner, position) {
                ...
                // VML (IE Proprietary implementation)
                    ...
                    translate[2] =
                        border && /^(r|b)/i.test(corner.string()) ? (BROWSER.ie === 8 ? 2 : 1) : 0;
        ...
        OVERLAY = function() {
            ...
            $.extend(self, {
                ...
                toggle: function(api, state, duration) {
                    ...
                    if (
                        (elem.is(':animated') && visible === state && prevState !== FALSE) ||
        ...
        PLUGINS.viewport = function(
            ...
            viewportHeight =
                viewport[0] === window ? viewport.height() : viewport.outerHeight(FALSE);
            viewportScroll = {
        ...
        PLUGINS.svg = function(api, svg, corner) {
            ...
            if (ownerDocument !== document && api.position.target !== 'mouse') {
                frameOffset = $(
                    (ownerDocument.defaultView || ownerDocument.parentWindow).frameElement,
                ).offset();
                if (frameOffset) {
        ...
        $.extend(Ie6.prototype, {
            ...
            init: function(qtip) {
                ...
                this.redrawContainer = $('<div/>', { id: NAMESPACE + '-rcontainer' }).appendTo(
                    document.body,
                );
