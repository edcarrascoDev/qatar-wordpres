    ...
    $.fn.extend({
        select2SortableOrder: function() {
            ...
            $this.each(function() {
                ...
                sorted = $(
                    $select2
                        .find('.select2-choices li[class!="select2-search-field"]')
                        .map(function() {
                            if (!this) {
                                return undefined;
                            }
        ...
        select2Sortable: function() {
            ...
            ($this = this.filter('[multiple]')), (validMethods = ['destroy']);
                ...
                $this.each(function() {
                    ...
                    switch (options.bindOrder) {
                        ...
                        default:
                            ...
                            $select
                                .closest('form')
                                .unbind('submit.select2sortable')
                                .on('submit.select2sortable', function() {
                                    $select.select2SortableOrder();
                                });
                            break;
                    }
