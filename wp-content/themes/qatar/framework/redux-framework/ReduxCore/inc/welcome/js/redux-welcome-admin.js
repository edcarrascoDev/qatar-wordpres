(function($) {
    ...
    $.redux_welcome.supportHash = function() {
        ...
        jQuery('.redux_support_hash').click(function(e) {
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        jQuery('#support_hash').val(
                            'http://support.redux.io/?id=' + response.identifier,
                        );
                        $button
    ...
    $.redux_welcome.initSupportPage = function() {
        ...
        jQuery('#is_developer').click(function() {
        ...
        jQuery('#support_div .next').click(function() {
        ...
        jQuery('#support_div .previous').click(function() {
            if (animating) return false;
            animating = true;
