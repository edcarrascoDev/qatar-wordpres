    ...
    redux.field_objects.import_export.init = function(selector) {
        if (!selector) {
            selector = $(document)
                ...
                .find('.redux-container-import_export:visible');
        }
        ...
        $(selector).each(function() {
            ...
            el.each(function() {
                ...
                $(this)
                    .find('#redux-export-code-copy')
                    .click(function() {
                        var $el = $('#redux-export-code');
                        if ($('#redux-export-link-value').is(':visible')) {
                            $('#redux-export-link-value').slideUp('fast', function() {
                                $el.slideDown('medium', function() {
                ...
                $(this)
                    .find('#redux-export-link')
                    .click(function() {
                        var $el = $('#redux-export-link-value');
                        if ($('#redux-export-code').is(':visible')) {
                            $('#redux-export-code').slideUp('fast', function() {
                                $el.slideDown()
                                    .focus()
                                    .select();
                            });
