        ...
        $.each(formAsArray, function(i, input) {
            ...
            if (type !== 'skip') {
                ...
                if (opts.parseWithFunction && type === '_')
                    value = opts.parseWithFunction(value, input.name); // allow for custom parsing
...
(function($) {
    //This functions first parameter is named $
    'use strict';
    ...
    redux.customizer.init = function() {
        ...
        $(
            '.accordion-section.redux-section, .accordion-section.redux-panel, .accordion-section-title',
        ).click(function() {
            $.redux.initFields();
        });
    ...
    redux.customizer.save = function($obj) {
        var $parent = $obj.hasClass('redux-field')
            ? $obj
            : $obj.parents('.redux-field-container:first');
