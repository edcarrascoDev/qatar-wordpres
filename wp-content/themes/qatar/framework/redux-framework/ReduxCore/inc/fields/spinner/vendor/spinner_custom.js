(function(a, b) {
    var c = 'ui-state-active',
        ...
        n = f.END,
        o = a.browser.msie,
        p = a.browser.mozilla ? 'DOMMouseScroll' : 'mousewheel',
        q = '.uispinner',
        r = [g, h, i, j, k, l, m, n, f.BACKSPACE, f.DELETE, f.TAB],
        s;
    a.widget('ui.spinner', {
        options: {
            min: null,
            ...
            format: function(a, b) {
                var c = this,
                    d = /(\d+)(\d{3})/,
                    e = (isNaN(a) ? 0 : Math.abs(a)).toFixed(b) + '';
                for (
                    e = e.replace('.', c.point);
                    d.test(e) && c.group;
                    e = e.replace(d, '$1' + c.group + '$2')
                ) {}
        ...
        _createButtons: function(b) {
            ...
            var p = this,
                ...
                v = t.width,
                w = t.showOn,
                x = a.support.boxModel,
                y = b.outerHeight(),
                z = (p.oMargin = e(b.css('margin-right'))),
                A = (p.wrapper = b
                    .wrap('<span class="spinner-wrpr" />')
                    .css({
                    ...
                    .after('<span class="ui-spinner ui-widget"></span>')
                    .next()),
                B = (p.btnContainer = a(
                    '<div class="ui-spinner-buttons">' +
                        '<div class="ui-spinner-up ui-spinner-button ui-state-default ui-corner-tr"><span class="ui-icon ' +
                        t.upIconClass +
                        '"> </span></div>' +
                        '<div class="ui-spinner-down ui-spinner-button ui-state-default ui-corner-br"><span class="ui-icon ' +
                        t.downIconClass +
                        '"> </span></div>' +
                        '</div>',
                )),
        ...
        _validate: function(a) {
            ...
            if (d != null && a > d) return d;
            else if (c != null && a < c) return c;
            else return a;
        },
        _change: function() {
            var a = this,
        ...
        showButtons: function(a) {
            ...
            if (a) b.css('opacity', 1);
            else b.fadeTo('fast', 1);
        },
        hideButtons: function(a) {
            var b = this.btnContainer.stop();
            if (a) b.css('opacity', 0);
            else b.fadeTo('fast', 0);
