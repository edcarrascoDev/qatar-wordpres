    ...
    redux.field_objects.button_set.init = function(selector) {
        if (!selector) {
            selector = $(document)
                ...
                .find('.redux-container-button_set:visible');
        }
        ...
        $(selector).each(function() {
            ...
            el.find('.buttonset').each(function() {
                if ($(this).is(':checkbox')) {
                    $(this)
                        .find('.buttonset-item')
                        .button();
            ...
            el.find('.buttonset-item.multi').on('click', function(e) {
                var val = '';
                var name = '';
                ...
                $(this)
                    .parent()
                    .find('#' + id + '-hidden.buttonset-check')
                    .val(val);
                $(this)
                    .parent()
                    .find('#' + id + '-hidden.buttonset-check')
