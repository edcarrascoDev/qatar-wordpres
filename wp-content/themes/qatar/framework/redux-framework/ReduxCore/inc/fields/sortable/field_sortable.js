    ...
    redux.field_objects.sortable.init = function(selector) {
        if (!selector) {
            selector = $(document)
                ...
                .find('.redux-container-sortable:visible');
        }
        ...
        $(selector).each(function() {
            ...
            el.find('.redux-sortable').sortable({
                ...
                out: function(event, ui) {
                    ...
                    redux.field_objects.sortable.scrolling(
                        $(this).parents('.redux-field-container:first'),
                    );
                },
            ...
            el.find('.checkbox_sortable').on('click', function() {
                if ($(this).is(':checked')) {
