...
(function($) {
    ...
    redux.field_objects.dimensions.init = function(selector) {
        ...
        $(selector).each(function() {
            ...
            el.find('.redux-dimensions-input').on('change', function() {
                var units = $(this)
                ...
                if (
                    $(this)
                        .parents('.redux-field:first')
                        .find('.redux-dimensions-units').length !== 0
                ) {
                    units = $(this)
                        .parents('.redux-field:first')
                        .find('.redux-dimensions-units option:selected')
                        .val();
                }
            ...
            el.find('.redux-dimensions-units').on('change', function() {
                $(this)
                    .parents('.redux-field:first')
                    .find('.redux-dimensions-input')
                    .change();
            });
        });
    };
