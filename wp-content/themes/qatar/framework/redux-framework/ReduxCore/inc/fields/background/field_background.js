    ...
    redux.field_objects.background.init = function(selector) {
        if (!selector) {
            selector = $(document)
                ...
                .find('.redux-container-background:visible');
        }
        ...
        $(selector).each(function() {
            ...
            el.find('.redux-remove-background')
                .unbind('click')
                .on('click', function(e) {
                    e.preventDefault();
                    redux.field_objects.background.removeImage(
                        $(this).parents('.redux-container-background:first'),
                    );
                    return false;
                });

            // Upload media button
            el.find('.redux-background-upload')
                .unbind()
                ...
                if ($(this).is(':checked')) {
                    ...
                    if (el.find('#' + $(this).data('id')).val() === 'transparent') {
                        ...
                        el.find('#' + $(this).data('id'))
                            ...
                            .parent()
                            .find('.wp-color-result')
                            .css('background-color', prevColor);
            ...
            el.find(
                ' .redux-background-repeat, .redux-background-clip, .redux-background-origin, .redux-background-size, .redux-background-attachment, .redux-background-position',
        ...
        frame.on('select', function() {
            ...
            if (!selector.find('.upload').hasClass('noPreview')) {
                selector
                    ...
                    .empty()
                    .hide()
                    .append('<img class="redux-option-image" src="' + thumbSrc + '">')
                    .slideDown('fast');
            }
