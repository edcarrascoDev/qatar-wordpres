(() => {
    ...
    l = {
      7915: (e, t, r) => {
        ...
        const g = ({ onChange: e, settings: t }) => {
            const { image: r, button: c, price: o, rating: a, title: n } = t,
              i = !1 !== r;
            return (0, l.createElement)(
              l.Fragment,
              null,
              (0, l.createElement)(h.ToggleControl, {
          ...
          w = ({
            ...
            (0, l.createElement)(
              l.Fragment,
              null,
              (0, l.createElement)(h.RangeControl, {
              ...
              (0, l.createElement)(h.ToggleControl, {
                label: (0, u.__)('Align the last block to the bottom', 'woocommerce'),
                help: c
                  ? (0, u.__)('Align the last block to the bottom.', 'woocommerce')
                  : (0, u.__)('The last inner block will follow other content.', 'woocommerce'),
                checked: c,
            ...
            const c = ['0'],
              ...
              a = e =>
                e.map(e => {
                  ...
                  return (
                    c.push('' + e.id),
                    { ...e, breadcrumbs: o(l[e.parent]), children: t && t.length ? a(t) : [] }
                  );
                }),
              n = a(r[0] || []);
            return (
              Object.entries(r).forEach(([e, t]) => {
                c.includes(e) || n.push(...a(t || []));
              }),
              n
            );
          },
            ...
            return e
              ...
              .map((e, t) =>
                r.test(e)
                  ...
                  : (0, l.createElement)(E.Fragment, { key: t }, e),
              );
          };
        function C(e, t, r) {
        ...
        const S = window.wp.htmlEntities,
          N = ({ label: e }) =>
          ...
          P = ({
            ...
            var g, p;
            const [w, b] = d,
              _ = null != e && void 0 !== o.count && null !== o.count,
              y = !(null === (g = o.breadcrumbs) || void 0 === g || !g.length),
              x = !(null === (p = o.children) || void 0 === p || !p.length),
              v = w === o.id,
              ...
              ? (0, l.createElement)(
                  ...
                  n
                    ? (0, l.createElement)(
                        ...
                        (0, l.createElement)(O, { item: o, search: s }),
                        _ ? (0, l.createElement)(N, { label: e || o.count }) : null,
                      )
                    : (0, l.createElement)(
                        l.Fragment,
                        null,
                        (0, l.createElement)(h.CheckboxControl, {
                          className: 'woocommerce-search-list__item-input',
                          checked: a,
                          ...(!a && o.children.some(e => m.find(t => t.id === e.id))
                            ? { indeterminate: !0 }
                            : {}),
                          label: k((0, S.decodeEntities)(o.name), s),
                          onChange: () => {
                            a
                              ? i(C(m, o.children, 'id'))()
                              : i(
              ...
              : (0, l.createElement)(
                  ...
                  n
                    ...
                    : (0, l.createElement)(h.CheckboxControl, {
                        ...
                        name: T,
                        className: 'woocommerce-search-list__item-input',
                        value: (0, S.decodeEntities)(o.value),
                        label: k((0, S.decodeEntities)(o.name), s),
                        onChange: i(o),
                        checked: a,
                      }),
        ...
        const A = ({
            ...
            const [i, s] = (0, E.useState)(!1),
              m = (0, y.useInstanceId)(A);
            if (((o = o || t), !t)) return null;
            t = (0, S.decodeEntities)(t);
            const d = f()('woocommerce-tag', n, { 'has-remove': !!c }),
              g = `woocommerce-tag__label-${m}`,
              p = (0, l.createElement)(
                l.Fragment,
                null,
                (0, l.createElement)('span', { className: 'screen-reader-text' }, o),
            ...
            return (0, l.createElement)(
              ...
              r
                ...
                : (0, l.createElement)('span', { className: 'woocommerce-tag__text', id: g }, p),
              r && i && (0, l.createElement)(h.Popover, { onClose: () => s(!1) }, r),
              c &&
                (0, l.createElement)(
                  h.Button,
                  {
          ...
          B = A;
        r(8137);
        const R = e => (0, l.createElement)(T, { ...e }),
          j = e => {
            const {
                list: t,
                selected: r,
              ...
              ? (0, l.createElement)(
                  ...
                  t.map(t => {
                    ...
                    return (0, l.createElement)(
                      ...
                      p ? (0, l.createElement)(j, { ...e, list: t.children, depth: o + 1 }) : null,
                    );
                  }),
                )
              : null;
          ...
          F = ({
            ...
            return (0, l.createElement)(
              ...
              (0, l.createElement)(
                ...
                (0, l.createElement)('strong', null, c.selected(n)),
                n > 0
                  ? (0, l.createElement)(
                      h.Button,
                      {
                ...
                ? (0, l.createElement)(
                    ...
                    r.map((e, t) =>
                      (0, l.createElement)(
                        'li',
                        { key: t },
                        (0, l.createElement)(B, { label: e.name, id: e.id, remove: a }),
                      ),
                    ),
                  )
                : null,
          ...
          $ = ({
            ...
            onSelect: r,
            instanceId: c,
            useExpandedPanelId: o,
            ...n
          }) => {
            const { messages: i, renderItem: s, selected: m, isSingle: d } = n,
              h = s || R;
            return 0 === e.length
              ? (0, l.createElement)(
                  'div',
                  ...
                  (0, l.createElement)(
                    ...
                    (0, l.createElement)(a.A, { icon: b.A, role: 'img' }),
                  ),
                  (0, l.createElement)(
                    'span',
          ...
          M = e => {
                ...
                () =>
                  ((e, t, r) => {
                    ...
                    const l = new RegExp(t.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'), 'i'),
                      c = e.map(e => !!l.test(e.name) && e).filter(Boolean);
                    return r ? v(c, e) : c;
                  })(n, w, c),
                [n, w, c],
              );
            ...
            return (0, l.createElement)(
              ...
              'text' === g && (0, l.createElement)(F, { ...e, onRemove: N, messages: C }),
              (0, l.createElement)(
                'div',
                { className: 'woocommerce-search-list__search' },
                'text' === g
                  ? (0, l.createElement)(h.TextControl, {
                      label: C.search,
                      type: 'search',
                      value: w,
                      onChange: e => b(e),
                    })
                  : (0, l.createElement)(h.FormTokenField, {
                      disabled: o,
                      label: C.search,
                      onChange: P,
                      onInputChange: e => b(e),
              ...
              o
                ? (0, l.createElement)(
                    'div',
                    { className: 'woocommerce-search-list__list' },
                    (0, l.createElement)(h.Spinner, null),
                  )
                : (0, l.createElement)($, {
                    ...e,
                    search: w,
        ...
        (0, h.withSpokenMessages)(M);
        var L = r(4717);
        const D = ({ item: e, search: t, depth: r = 0, ...c }) => {
            const o = e.breadcrumbs.length ? `${e.breadcrumbs.join(', ')}, ${e.name}` : e.name;
            return (0, l.createElement)(P, {
              className: f()('woocommerce-product-tags__item', 'has-count', {
                'is-searching': t.length > 0,
                'is-skip-level': 0 === r && 0 !== e.parent,
              }),
              item: e,
              search: t,
              depth: r,
              ...c,
              ariaLabel: (0,
              u.sprintf) /* translators: %1$d is the count of products, %2$s is the name of the tag. */(
        ...
        const J = ({ selected: e = [], search: t }) => {
          const r = (({ selected: e = [], search: t }) => {
            const r = (0, o.getSetting)('limitTags', !1),
              l = [
                (0, W.addQueryArgs)('wc/store/v1/products/tags', {
                  per_page: r ? 100 : 0,
                  orderby: r ? 'count' : 'name',
                  order: r ? 'desc' : 'asc',
                  search: t,
                }),
              ];
            return (
              r &&
                e.length &&
                l.push((0, W.addQueryArgs)('wc/store/v1/products/tags', { include: e })),
              l
            );
          })({ selected: e, search: t });
          return Promise.all(r.map(e => H()({ path: e }))).then(e =>
            ((e, t) => {
              const r = new Map();
              return e.filter(e => {
                const l = t(e);
        ...
        const Q = ({
            ...
            const [n, i] = (0, E.useState)([]),
              [s, m] = (0, E.useState)(!0),
              [d, g] = (0, E.useState)(!1),
              p = (0, o.getSetting)('limitTags', !1),
              w = (0, E.useMemo)(() => n.filter(e => a.includes(e.id)), [n, a]),
              b = (0, E.useCallback)(
                e => {
                  m(!0),
                    J({ selected: a, search: e })
                      .then(e => {
                        i(e), m(!1);
                      })
                      .catch(() => {
            ...
            const _ = (0, L.YQ)(b, 400),
              f = {
                clear: (0, u.__)('Clear all product tags', 'woocommerce'),
                list: (0, u.__)('Product Tags', 'woocommerce'),
                noItems: (0, u.__)(
                  'You have not set up any product tags on your store.',
                  'woocommerce',
                ),
                search: (0, u.__)('Search for product tags', 'woocommerce'),
                selected: e =>
                  (0, u.sprintf) /* translators: %d is the count of selected tags. */(
                    /* translators: %d is the count of selected tags. */
                    (0, u._n)('%d tag selected', '%d tags selected', e, 'woocommerce'),
                    e,
                  ),
                updated: (0, u.__)('Tag search results updated.', 'woocommerce'),
              };
            return (0, l.createElement)(
              l.Fragment,
              null,
              ...
              !!r &&
                (0, l.createElement)(
                  'div',
                  { hidden: a.length < 2 },
                  (0, l.createElement)(h.SelectControl, {
                    className: 'woocommerce-product-tags__operator',
                    label: (0, u.__)('Display products matching', 'woocommerce'),
                    help: (0, u.__)('Pick at least two tags to use this setting.', 'woocommerce'),
                    value: c,
                    onChange: r,
                    options: [
                      { label: (0, u.__)('Any selected tags', 'woocommerce'), value: 'any' },
                      { label: (0, u.__)('All selected tags', 'woocommerce'), value: 'all' },
                    ],
                  }),
                ),
            );
          ...
          Y = (0, o.getSetting)('hideOutOfStockItems', !1),
          z = (0, o.getSetting)('stockStatusOptions', {}),
          K = ({ value: e, setAttributes: t }) => {
            const { outofstock: r, ...c } = z,
              o = Y ? c : z,
              a = Object.entries(o)
                .map(([e, t]) => ({ value: e, label: t }))
                .filter(e => !!e.label),
              n = Object.keys(o).filter(e => !!e),
              [i, s] = (0, E.useState)(e || n);
            (0, E.useEffect)(() => {
              t({ stockStatus: ['', ...i] });
            }, [i, t]);
              ...
              a.map(e => {
                const t = i.includes(e.value)
                  ? /* translators: %s stock status. */ /* translators: %s stock status. */ (0,
                    u.__)('Stock status "%s" visible.', 'woocommerce')
                  : /* translators: %s stock status. */ /* translators: %s stock status. */ (0,
                    u.__)('Stock status "%s" hidden.', 'woocommerce');
                return (0, l.createElement)(h.ToggleControl, {
                  label: e.label,
                  key: e.value,
                  help: (0, u.sprintf)(t, e.label),
          ...
          U = window.wc.wcTypes,
          X = (0, h.withSpokenMessages)(
            ({ attributes: e, name: t, setAttributes: r, debouncedSpeak: c }) => {
              const [i, m] = (0, E.useState)({}),
                [p, b] = (0, E.useState)(!1);
              (0, E.useEffect)(() => {
                e.tags.length || b(!0);
              }, [e.tags.length]);
              ...
              return e.isPreview
                ...
                ? (0, l.createElement)(
                    ...
                    (0, l.createElement)(
                      s.BlockControls,
                      null,
                      (0, l.createElement)(h.ToolbarGroup, {
                        controls: [
                          {
                            icon: 'edit',
                            title: (0, u.__)('Edit selected tags', 'woocommerce'),
                            onClick: () => (p ? _() : (b(!0), void m({}))),
                            isActive: p,
                          },
                        ],
                      }),
                    ...
                    (() => {
                      ...
                      return (0, l.createElement)(
                        ...
                        (0, l.createElement)(
                          h.PanelBody,
                          {
                            title: (0, u.__)('Product Tag', 'woocommerce'),
                          ...
                          (0, l.createElement)(Q, {
                            ...
                            operator: c,
                            onOperatorChange: (e = 'any') => r({ tagOperator: e }),
                            isCompact: !0,
                          }),
                        ),
                        (0, l.createElement)(
                          ...
                          (0, l.createElement)(w, {
                            ...
                            alignButtons: m,
                            setAttributes: r,
                            minColumns: (0, o.getSettingWithCoercion)('minColumns', 1, U.isNumber),
                            maxColumns: (0, o.getSettingWithCoercion)('maxColumns', 6, U.isNumber),
                            minRows: (0, o.getSettingWithCoercion)('minRows', 6, U.isNumber),
                            maxRows: (0, o.getSettingWithCoercion)('maxRows', 6, U.isNumber),
                          }),
                        ),
                        (0, l.createElement)(
                          h.PanelBody,
                        ...
                        (0, l.createElement)(
                          ...
                          (0, l.createElement)(G, { setAttributes: r, value: n }),
                        ),
                        (0, l.createElement)(
                          h.PanelBody,
                          {
                            title: (0, u.__)('Filter by stock status', 'woocommerce'),
                            initialOpen: !1,
                          },
                          (0, l.createElement)(K, { setAttributes: r, value: d }),
                        ),
                      );
                    })(),
                    p
                      ? (() => {
                          ...
                          return (0, l.createElement)(
                            h.Placeholder,
                            {
                              icon: (0, l.createElement)(a.A, {
                                icon: n.A,
                                className: 'block-editor-block-icon',
                              }),
                              label: (0, u.__)('Products by Tag', 'woocommerce'),
                            ...
                            (0, l.createElement)(
                              'div',
                              { className: 'wc-block-product-tag__selection' },
                              (0, l.createElement)(Q, {
                                selected: t.tags,
                                onChange: (e = []) => {
                                  const t = e.map(({ id: e }) => e);
                                ...
                                onOperatorChange: (e = 'any') => m({ ...i, tagOperator: e }),
                              }),
                              (0, l.createElement)(
                                h.Button,
                                {
                      ...
                      : (() => {
                          const r = e.tags.length;
                          return (0, l.createElement)(
                            h.Disabled,
                            null,
                            r
                              ? (0, l.createElement)(d(), { block: t, attributes: e })
                              : (0, l.createElement)(
                                  h.Placeholder,
                                  {
                                    icon: (0, l.createElement)(a.A, {
        ...
        r(218),
          (0, c.registerBlockType)(i, {
            ...
            attributes: {
              ...i.attributes,
              columns: { type: 'number', default: (0, o.getSetting)('defaultColumns', 3) },
              rows: { type: 'number', default: (0, o.getSetting)('defaultRows', 3) },
              tags: { type: 'array', default: [] },
              stockStatus: {
                type: 'array',
                default: Object.keys((0, o.getSetting)('stockStatusOptions', [])),
              },
            },
            edit: e => {
              const t = (0, s.useBlockProps)();
              return (0, l.createElement)('div', { ...t }, (0, l.createElement)(X, { ...e }));
            },
            save: () => null,
          });
      },
  ...
  (o.m = l),
    ...
    (o.O = (t, r, l, c) => {
      if (!r) {
        ...
        for (m = 0; m < e.length; m++) {
          for (var [r, l, c] = e[m], n = !0, i = 0; i < r.length; i++)
            (!1 & c || a >= c) && Object.keys(o.O).every(e => o.O[e](r[i]))
              ? r.splice(i--, 1)
              : ((n = !1), c < a && (a = c));
          if (n) {
            e.splice(m--, 1);
    ...
    (o.t = function(e, l) {
      ...
      var a = {};
      t = t || [null, r({}), r([]), r(r)];
      for (var n = 2 & l && e; 'object' == typeof n && !~t.indexOf(n); n = r(n))
    ...
    (() => {
      ...
      var t = (t, r) => {
          var l,
            ...
            s = 0;
          if (a.some(t => 0 !== e[t])) {
            for (l in n) o.o(n, l) && (o.m[l] = n[l]);
            if (i) var m = i(o);
          }
          for (t && t(r); s < a.length; s++) (c = a[s]), o.o(e, c) && e[c] && e[c][0](), (e[c] = 0);
          return o.O(m);
        },
  ...
  var a = o.O(void 0, [94], () => o(7915));
  (a = o.O(a)), (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['product-tag'] = a);
})();
