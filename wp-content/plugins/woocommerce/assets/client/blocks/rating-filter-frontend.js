...
(() => {
  var e,
    ...
    o = {
      5256: (e, t, r) => {
        ...
        var c, i, u, d, p, m, g, w, f, b;
        const _ = (0, l.getSetting)('wcBlocksConfig', {
            buildPhase: 1,
            pluginUrl: '',
            productCount: 0,
            defaultAvatar: '',
          ...
          y = _.pluginUrl + 'assets/images/',
          E =
            (_.pluginUrl,
            _.buildPhase,
            null === (c = l.STORE_PAGES.shop) || void 0 === c || c.permalink,
            null === (i = l.STORE_PAGES.checkout) || void 0 === i || i.id,
            ...
            null === (w = l.STORE_PAGES.cart) || void 0 === w || w.id,
            null === (f = l.STORE_PAGES.cart) || void 0 === f || f.permalink,
            null !== (b = l.STORE_PAGES.myaccount) && void 0 !== b && b.permalink
          ...
          k =
            ((0, l.getSetting)('addressFieldsLocations', h).address,
            (0, l.getSetting)('addressFieldsLocations', h).contact,
            (0, l.getSetting)('addressFieldsLocations', h).order,
            (0, l.getSetting)('additionalOrderFields', {}),
            (0, l.getSetting)('additionalContactFields', {}),
            (0, l.getSetting)('additionalAddressFields', {}),
            ({
              imageUrl: e = `${y}/block-error.svg`,
          ...
          x = ({
            ...
            0 !== t.length &&
              Array.prototype.forEach.call(t, (t, a) => {
                ...
                })({ Block: e, container: t, props: l, attributes: i, errorBoundaryProps: c });
              });
          };
        var C = r(195),
          R = r(7104),
          ...
          B = r.n(A);
        r(8887);
        const j = ({ className: e, rating: t, ratedProductsCount: r }) => {
          const n = B()('wc-block-components-product-rating', e),
            s = { width: (t / 5) * 100 + '%' },
            l = (0, a.sprintf) /* translators: %f is referring to the average rating value */(
            ...
            c = {
              __html: (0,
              a.sprintf) /* translators: %s is the rating value wrapped in HTML strong tags. */(
          ...
          return (0, o.createElement)(
            ...
            (0, o.createElement)(
              ...
              (0, o.createElement)('span', { style: s, dangerouslySetInnerHTML: c }),
            ),
            null !== r
              ? (0, o.createElement)(
                  'span',
        ...
        const M = window.wc.wcBlocksData,
          ...
          G =
            ...
            e => {
              const t = U();
              e = e || t;
              const r = (0, q.useSelect)(
                  t => t(M.QUERY_STATE_STORE_KEY).getValueForQueryContext(e, void 0),
                  [e],
                ),
                { setValueForQueryContext: o } = (0, q.useDispatch)(M.QUERY_STATE_STORE_KEY);
              return [
                r,
                (0, n.useCallback)(
                  t => {
          ...
          K = (e, t, r) => {
            ...
            const s = (0, q.useSelect)(
                o => o(M.QUERY_STATE_STORE_KEY).getValueForQueryKey(r, e, t),
                [r, e],
              ),
              { setQueryValue: a } = (0, q.useDispatch)(M.QUERY_STATE_STORE_KEY);
            return [
              s,
              (0, n.useCallback)(
                t => {
        ...
        const V = ({
            ...
            l = `${l}-collection-data`;
            const [c] = G(l),
              [i, u] = K('calculate_attribute_counts', [], l),
              [d, p] = K('calculate_price_range', null, l),
              [m, g] = K('calculate_stock_status_counts', null, l),
              [w, f] = K('calculate_rating_counts', null, l),
              b = F(e || {}),
              _ = F(t),
              y = F(r),
              E = F(o);
            (0, n.useEffect)(() => {
              'object' == typeof b &&
                ...
                (i.find(e => (0, D.objectHasProp)(b, 'taxonomy') && e.taxonomy === b.taxonomy) ||
                  u([...i, b]));
            }, [b, i, u]),
              (0, n.useEffect)(() => {
                d !== _ && void 0 !== _ && p(_);
            ...
            return (e => {
              ...
              const l = (0, n.useRef)({ results: [], isLoading: !0 }),
                ...
                d = (0, q.useSelect)(
                  e => {
                    if (!a) return null;
                    const o = e(M.COLLECTIONS_STORE_KEY),
                      n = [t, r, c, i],
              ...
              query: { ...s, page: void 0, per_page: void 0, orderby: void 0, order: void 0, ...S },
              shouldSelect: k,
            });
          },
          W = window.wc.blocksComponents;
        r(1504);
        const H = ({
          className: e,
          isLoading: t,
          ...
          (0, o.createElement)(
            ...
            (0, o.createElement)(W.Label, { label: n, screenReaderLabel: l }),
          );
        r(8335);
        const $ = ({
          className: e,
          ...
          (0, o.createElement)(
            'button',
            { className: B()('wc-block-components-filter-reset-button', e), onClick: r },
        ...
        const z = ({
            ...
            (0, o.createElement)(
              'div',
              {
                className: B()('wc-blocks-components-form-token-field-wrapper', e, {
                  'single-selection': !n,
                }),
                style: t,
              },
              (0, o.createElement)(J.A, {
                label: c,
          ...
          Z = window.wp.url,
          X = (0, l.getSettingWithCoercion)('isRenderingPhpTemplate', !1, D.isBoolean);
        function ee(e) {
          if (X) {
            const t = new URL(e);
        ...
        const te = e => {
            const t = (0, Z.getQueryArgs)(e);
            return (0, Z.addQueryArgs)(e, t);
          },
          re = [
            {
              label: (0, o.createElement)(j, { key: 5, rating: 5, ratedProductsCount: null }),
              value: '5',
            },
            {
              label: (0, o.createElement)(j, { key: 4, rating: 4, ratedProductsCount: null }),
              value: '4',
            },
            {
              label: (0, o.createElement)(j, { key: 3, rating: 3, ratedProductsCount: null }),
              value: '3',
            },
            {
              label: (0, o.createElement)(j, { key: 2, rating: 2, ratedProductsCount: null }),
              value: '2',
            },
            {
              label: (0, o.createElement)(j, { key: 1, rating: 1, ratedProductsCount: null }),
              value: '1',
            },
          ];
        r(8692);
        const oe = JSON.parse('{"uK":{"Ox":{"A":"list"},"dc":{"A":"multiple"}}}');
        function ne() {
        ...
        const se = e =>
          ...
          le = 'rating_filter',
          ce = e =>
            (0, a.sprintf) /* translators: %s is referring to the average rating value */(
        ...
        (e => {
          ...
          (({ Block: e, getProps: t, getErrorBoundaryProps: r, selector: o, wrappers: n }) => {
            ...
            n &&
              ...
              x({ Block: e, containers: s, getProps: t, getErrorBoundaryProps: r });
          ...
          Block: ({ attributes: e, isEditor: t, noRatingsNotice: r = null }) => {
            const s = (() => {
                const { wrapper: e } = (0, n.useContext)(ae);
                return t => {
                  e && e.current && (e.current.hidden = !t);
                };
              })(),
              c = (0, l.getSettingWithCoercion)('isRenderingPhpTemplate', !1, D.isBoolean),
              [i, u] = (0, n.useState)(!1),
              [d] = G(),
              { results: p, isLoading: m } = V({ queryRating: !0, queryState: d, isEditor: t }),
              [g, w] = (0, n.useState)(e.isPreview ? re : []),
              f = !e.isPreview && m && 0 === g.length,
              b = !e.isPreview && m,
              _ = (0, n.useMemo)(
                () =>
                  ((e = 'filter_rating') => {
                    const t =
                      ((r = e), window ? (0, Z.getQueryArg)(window.location.href, r) : null);
                    var r;
                    return t ? ((0, D.isString)(t) ? t.split(',') : t) : [];
                  })('rating_filter'),
                [],
              ),
              [y, E] = (0, n.useState)(_),
              ...
              A = x ? !f && y.length < g.length : !f && 0 === y.length,
              N = (0, n.useCallback)(
                e => {
                  t ||
                    (e && !c && h(e),
                    (e => {
                      if (!window) return;
                      if (0 === e.length) {
                        const e = (0, Z.removeQueryArgs)(window.location.href, le);
                        return void (e !== te(window.location.href) && ee(e));
                      }
                      const t = (0, Z.addQueryArgs)(window.location.href, { [le]: e.join(',') });
                      t !== te(window.location.href) && ee(t);
                    })(e));
                },
                [t, h, c],
              );
            (0, n.useEffect)(() => {
              e.showFilterButton || N(y);
            }, [e.showFilterButton, y, N]);
            const M = F((0, n.useMemo)(() => v, [v])),
              q = (function(e, t) {
                const r = (0, n.useRef)();
                return (
                  (0, n.useEffect)(() => {
            ...
            (0, n.useEffect)(() => {
              ...
              (0, n.useEffect)(() => {
                if (m || e.isPreview) return;
                const r =
                  !m && (0, D.objectHasProp)(p, 'rating_counts') && Array.isArray(p.rating_counts)
                    ? [...p.rating_counts].reverse()
                    : [];
                if (t && 0 === r.length) return w(re), void O(!0);
                const n = r
                  .filter(e => (0, D.isObject)(e) && Object.keys(e).length > 0)
                  .map(t => {
                    var r;
                    return {
                      ...
                      value:
                        null == t || null === (r = t.rating) || void 0 === r
                          ? void 0
                          : r.toString(),
                    };
                  });
                w(n), S(ne());
              }, [e.showCounts, e.isPreview, p, m, v, t]);
            const Q = (0, n.useCallback)(
              e => {
                const t = y.includes(e);
                if (!x) {
                  const r = t ? [] : [e];
                  return (0, C.speak)(t ? ie(e) : ce(e)), void E(r);
                }
                if (t) {
                  const t = y.filter(t => t !== e);
                  return (0, C.speak)(ie(e)), void E(t);
                }
                const r = [...y, e].sort((e, t) => Number(t) - Number(e));
                (0, C.speak)(ce(e)), E(r);
              },
              [y, x],
            );
            return (m || 0 !== g.length) &&
              (0, l.getSettingWithCoercion)('hasFilterableProducts', !1, D.isBoolean)
              ? (s(!0),
                (0, o.createElement)(
                  o.Fragment,
                  null,
                  ...
                  (0, o.createElement)(
                    'div',
                    {
                      className: B()('wc-block-rating-filter', `style-${e.displayStyle}`, {
                        'is-loading': f,
                      }),
                    },
                    'dropdown' === e.displayStyle
                      ? (0, o.createElement)(
                          ...
                          (0, o.createElement)(z, {
                            key: k,
                            className: B()({ 'single-selection': !x, 'is-loading': f }),
                            style: { borderStyle: 'none' },
                            suggestions: g.filter(e => !y.includes(e.value)).map(e => e.value),
                            disabled: f,
                            placeholder: (0, a.__)('Select Rating', 'woocommerce'),
                            onChange: e => {
                              !x && e.length > 1 && (e = [e[e.length - 1]]);
                              const t = [
                                (e = e.map(e => {
                              ...
                              if (1 === t.length) return Q(t[0]);
                              const r = [y, e].reduce((e, t) => e.filter(e => !t.includes(e)));
                              1 === r.length && Q(r[0]);
                            },
                            value: y,
                            displayTransform: e => {
                            ...
                            saveTransform: se,
                            messages: {
                              added: (0, a.__)('Rating filter added.', 'woocommerce'),
                              removed: (0, a.__)('Rating filter removed.', 'woocommerce'),
                              remove: (0, a.__)('Remove rating filter.', 'woocommerce'),
                          ...
                          A && (0, o.createElement)(R.A, { icon: T.A, size: 30 }),
                        )
                  ...
                  (0, o.createElement)(
                    ...
                    (y.length > 0 || t) &&
                      ...
                      (0, o.createElement)($, {
                        ...
                        screenReaderLabel: (0, a.__)('Reset rating filter', 'woocommerce'),
                      }),
                    e.showFilterButton &&
                      (0, o.createElement)(H, {
            ...
            return {
              attributes:
                ((t = e.dataset),
                {
                  ...
                  isPreview: !1,
                  displayStyle:
                    ((0, D.isString)(null == t ? void 0 : t.displayStyle) && t.displayStyle) ||
                    oe.uK.Ox.A,
                  selectType:
                    ((0, D.isString)(null == t ? void 0 : t.selectType) && t.selectType) ||
                    oe.uK.dc.A,
                }),
              isEditor: !1,
            };
  ...
  (s.m = o),
    ...
    (s.O = (t, r, o, n) => {
      if (!r) {
        ...
        for (u = 0; u < e.length; u++) {
          for (var [r, o, n] = e[u], l = !0, c = 0; c < r.length; c++)
            (!1 & n || a >= n) && Object.keys(s.O).every(e => s.O[e](r[c]))
              ? r.splice(c--, 1)
              : ((l = !1), n < a && (a = n));
          if (l) {
            e.splice(u--, 1);
    ...
    (() => {
      ...
      var t = (t, r) => {
          ...
          for (t && t(r); i < a.length; i++) (n = a[i]), s.o(e, n) && e[n] && e[n][0](), (e[n] = 0);
          return s.O(u);
        },
  ...
  var a = s.O(void 0, [94], () => s(5256));
  (a = s.O(a)), ((wc = void 0 === wc ? {} : wc)['rating-filter'] = a);
})();
