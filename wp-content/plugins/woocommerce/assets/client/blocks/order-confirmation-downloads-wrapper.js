    ...
    r = {
      7135: (e, o, t) => {
        ...
        const p = JSON.parse(
          ...
          u = { heading: { type: 'string', default: (0, t(7723).__)('Downloads', 'woocommerce') } };
        (0, n.registerBlockType)(p, {
          icon: {
          ...
          edit: ({ attributes: e, setAttributes: o }) => {
            const t = (0, a.useBlockProps)(),
              n = (0, c.getSetting)('storeHasDownloadableProducts');
            return (0, r.createElement)(
              'div',
              { ...t, className: d()(t.className, { 'store-has-downloads': n }) },
              (0, r.createElement)(a.InnerBlocks, {
                ...
                template: [
                  ...
                  ['woocommerce/order-confirmation-downloads', { lock: { remove: !0 } }],
                ],
              }),
            );
          },
  ...
  (a.m = r),
    ...
    (a.O = (o, t, r, n) => {
      if (!t) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [t, r, n] = e[d], i = !0, c = 0; c < t.length; c++)
            (!1 & n || s >= n) && Object.keys(a.O).every(e => a.O[e](t[c]))
              ? t.splice(c--, 1)
              : ((i = !1), n < s && (s = n));
          if (i) {
            e.splice(d--, 1);
    ...
    (a.t = function(e, r) {
      ...
      for (var i = 2 & r && e; 'object' == typeof i && !~o.indexOf(i); i = t(i))
        Object.getOwnPropertyNames(i).forEach(o => (s[o] = () => e[o]));
      return (s.default = () => e), a.d(n, s), n;
    }),
    (a.d = (e, o) => {
      for (var t in o)
        a.o(o, t) && !a.o(e, t) && Object.defineProperty(e, t, { enumerable: !0, get: o[t] });
    }),
    ...
    (() => {
      ...
      var o = (o, t) => {
          ...
          for (o && o(t); l < s.length; l++) (n = s[l]), a.o(e, n) && e[n] && e[n][0](), (e[n] = 0);
          return a.O(d);
        },
