(() => {
  ...
  (() => {
    ...
    const e = window.React,
      ...
      d = window.wp.plugins;
    o(144);
    const u = e => e.some(e => 'woocommerce/legacy-template' === e.name || u(e.innerBlocks)),
      p = () => {
        var o, d, p;
        const { blocks: m, editedPostId: w } = (0, r.useSelect)(
          ...
          P = (0, i.useMemo)(
            () =>
              (e =>
                e.reduce((e, t) => ('core/template-part' === t.name ? e : [...e, t.clientId]), []))(
                m,
              ),
            [m],
          );
                        ...
                        (0, n.createBlock)(
                          ...
                          [
                            (0, n.createBlock)('woocommerce/legacy-template', {
                              template:
                                null == v || null === (e = v.record) || void 0 === e
                                  ? void 0
                                  : e.slug,
                            }),
                          ],
