(() => {
  var e,
    ...
    r = {
      2085: (e, t, o) => {
        ...
        var l, p, d, u, g, m, f, w, v, b;
        const O = (0, c.getSetting)('wcBlocksConfig', {
            buildPhase: 1,
            pluginUrl: '',
            productCount: 0,
            defaultAvatar: '',
          ...
          S =
            ...
            O.pluginUrl,
            O.buildPhase,
            null === (l = c.STORE_PAGES.shop) || void 0 === l || l.permalink,
            null === (p = c.STORE_PAGES.checkout) || void 0 === p ? void 0 : p.id),
          k =
            (null === (d = c.STORE_PAGES.checkout) || void 0 === d || d.permalink,
            null === (u = c.STORE_PAGES.privacy) || void 0 === u || u.permalink,
            null === (g = c.STORE_PAGES.privacy) || void 0 === g || g.title,
            null === (m = c.STORE_PAGES.terms) || void 0 === m || m.permalink,
            null === (f = c.STORE_PAGES.terms) || void 0 === f || f.title,
            null === (w = c.STORE_PAGES.cart) || void 0 === w ? void 0 : w.id),
          y =
        ...
        (0, c.getSetting)('addressFieldsLocations', h).address,
          (0, c.getSetting)('addressFieldsLocations', h).contact,
          (0, c.getSetting)('addressFieldsLocations', h).order,
          (0, c.getSetting)('additionalOrderFields', {}),
          (0, c.getSetting)('additionalContactFields', {}),
          (0, c.getSetting)('additionalAddressFields', {});
        var _ = o(6087);
        const P = JSON.parse(
          '{"name":"woocommerce/page-content-wrapper","version":"1.0.0","title":"WooCommerce Page","description":"Displays WooCommerce page content.","category":"woocommerce","keywords":["WooCommerce"],"textdomain":"woocommerce","supports":{"html":false,"multiple":false,"inserter":false},"attributes":{"page":{"type":"string","default":""}},"providesContext":{"postId":"postId","postType":"postType"},"apiVersion":2,"$schema":"https://schemas.wp.org/trunk/block.json"}',
        );
        o(687),
          (0, i.registerBlockType)(P, {
            icon: { src: s.A },
            ...
            save: () => (0, r.createElement)(a.InnerBlocks.Content, null),
            variations: [
              {
                name: 'checkout-page',
                title: (0, n.__)('Checkout Page', 'woocommerce'),
                attributes: { page: 'checkout' },
                isActive: (e, t) => e.page === t.page,
              },
              {
                name: 'cart-page',
                title: (0, n.__)('Cart Page', 'woocommerce'),
    ...
    (n.O = (t, o, r, i) => {
      if (!o) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [o, r, i] = e[p], s = !0, c = 0; c < o.length; c++)
  ...
  var a = n.O(void 0, [94], () => n(2085));
  (a = n.O(a)),
    (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['page-content-wrapper'] = a);
})();
