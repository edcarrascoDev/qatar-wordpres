(() => {
    ...
    r = {
      2314: (e, t, o) => {
        ...
        const s = (0, r.createElement)(
          ({ className: e, height: t, width: o, ...l }) =>
            (0, r.createElement)(
              n.SVG,
              {
                xmlns: 'http://www.w3.org/2000/svg',
                viewBox: '0 0 245 145',
                className: c()('woo-icon', e),
                width: o,
                height: t,
                ...l,
              },
        ...
        var m = o(7104),
          u = (o(4686), o(1792), o(2294)),
          d = o(6087),
          p = o(9491);
        const g = window.wp.hooks,
          h = (0, p.createHigherOrderComponent)(e => {
            class t extends d.Component {
              constructor(...e) {
                super(...e), (0, u.A)(this, 'mounted', !1);
              }
              componentDidMount() {
                const { block: e, setAttributes: t } = this.props;
                e.name.startsWith('woocommerce/') && t(this.getAttributesWithDefaults());
              }
              componentDidUpdate() {
              ...
              getAttributesWithDefaults() {
                const e = (0, l.getBlockType)(this.props.block.name);
                let t = this.props.attributes;
                return (
                  !this.mounted &&
                    this.props.block.name.startsWith('woocommerce/') &&
                    void 0 !== e.attributes &&
                    void 0 !== e.defaults &&
                    ((t = Object.assign({}, this.props.attributes || {})),
                    Object.keys(e.attributes).map(
                      o => (
                        void 0 === t[o] && void 0 !== e.defaults[o] && (t[o] = e.defaults[o]), o
                      ),
                    )),
                  t
                );
        ...
        (0, g.addFilter)('editor.BlockListBlock', 'woocommerce-blocks/block-list-block', h),
          (0, g.addFilter)(
          ...
          o(9345);
        const w = window.wp.domReady;
        var f = o.n(w);
        class b {
          register(e, t) {
            return Boolean((0, l.registerBlockType)(e, t));
          }
          unregister(e) {
            return Boolean((0, l.unregisterBlockType)(e));
          }
        }
        class k {
          register(e, t) {
            return Boolean((0, l.registerBlockVariation)(e, t));
          }
          unregister(e, t) {
            return Boolean((0, l.unregisterBlockVariation)(e, t));
          }
        }
        const v = window.wp.blockEditor,
          C = window.wp.data,
          y = ({ blocks: e, findCondition: t }) => {
            for (const o of e) {
              if (t(o)) return o;
              if (o.innerBlocks) {
                const e = y({ blocks: o.innerBlocks, findCondition: t });
                if (e) return e;
              }
            }
          },
            ...
            (0, r.createElement)(
              ...
              (0, r.createElement)(
                ...
                (0, r.createElement)(
                  ...
                  (0, r.createElement)('feGaussianBlur', {
          ...
          L = e => ('lock' === e ? { lock: { move: !0, remove: !0 } } : { lock: {} }),
          T = (e, t) => {
            if (void 0 !== t) {
          ...
          O = ({ blocks: e, lockBlocks: t }) => {
            for (const o of e) T(L(t ? 'lock' : 'unlock'), o);
          },
          P = (e, t) => {
            const o = (0, C.select)('core/block-editor').getBlock(t);
            null == o ||
              o.innerBlocks.forEach(t => {
                'core/group' === t.name && T({ layout: I(e) }, t);
              });
          },
          V = e => {
            var t;
            return `wc-block-product-gallery--has-next-previous-buttons-${
              null ===
                (t = (e => {
                  switch (e) {
                    case 'insideTheImage':
                      return { PrevButtonImage: _, NextButtonImage: x, classname: 'inside-image' };
                    case 'outsideTheImage':
                      return { PrevButtonImage: B, NextButtonImage: E, classname: 'outside-image' };
                    default:
                      return null;
                  }
                })(e)) || void 0 === t
        ...
        const H = {
            [N.OFF]: (0, i.__)('No thumbnails will be displayed.', 'woocommerce'),
            [N.LEFT]: (0, i.__)(
          ...
          W = ({ context: e }) => {
            const { productGalleryClientId: t } = e,
              { updateBlockAttributes: o } = (0, C.useDispatch)(v.store);
            return (0, r.createElement)(
              ...
              (0, r.createElement)(
                ...
                (0, r.createElement)(G.__experimentalToggleGroupControlOption, {
                  value: N.LEFT,
                  label: (0, r.createElement)(m.A, { size: 32, icon: S }),
                }),
                (0, r.createElement)(G.__experimentalToggleGroupControlOption, {
                  value: N.BOTTOM,
                  label: (0, r.createElement)(m.A, { size: 32, icon: M }),
                }),
                (0, r.createElement)(G.__experimentalToggleGroupControlOption, {
                  value: N.RIGHT,
                  label: (0, r.createElement)(m.A, { size: 32, icon: A }),
                }),
              ),
              e.thumbnailsPosition !== N.OFF &&
        ...
        (0, r.createElement)(
          ...
          (0, r.createElement)(
            n.SVG,
            { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 12 12' },
            (0, r.createElement)('circle', { cx: '6', cy: '6', r: '6', fill: 'black' }),
          );
        const F = () =>
            (0, r.createElement)(
              n.SVG,
          ...
          j = ({ context: e }) => {
            const { productGalleryClientId: t, pagerDisplayMode: o } = e,
              { updateBlockAttributes: l } = (0, C.useDispatch)(v.store);
            return (0, r.createElement)(
              G.__experimentalToggleGroupControl,
              {
              ...
              (0, r.createElement)(G.__experimentalToggleGroupControlOption, {
                value: Z.DOTS,
                label: (0, r.createElement)(F, null),
              }),
              (0, r.createElement)(G.__experimentalToggleGroupControlOption, {
                value: Z.DIGITS,
                label: (0, r.createElement)(D, null),
              }),
            );
          };
        let z = (function(e) {
        ...
        const U = {
            [z.insideTheImage]: (0, r.createElement)(
              () =>
                (0, r.createElement)(
                  n.SVG,
                  {
            ...
            [z.outsideTheImage]: (0, r.createElement)(
              () =>
                (0, r.createElement)(
                  n.SVG,
                  {
          ...
          $ = ({ context: e }) => {
            ...
            return (0, r.createElement)(
              G.__experimentalToggleGroupControl,
              {
                label: (0, i.__)('Next/Prev Buttons', 'woocommerce'),
                className: 'wc-block-editor-product-gallery-large-image-next-previous-settings',
                style: { width: '100%' },
                onChange: e => l(t, { nextPreviousButtonsPosition: e }),
                help: J(o),
                value: o,
              },
              (0, r.createElement)(G.__experimentalToggleGroupControlOption, {
              ...
              (0, r.createElement)(G.__experimentalToggleGroupControlOption, {
                value: z.insideTheImage,
                label: U.insideTheImage,
              }),
              (0, r.createElement)(G.__experimentalToggleGroupControlOption, {
                value: z.outsideTheImage,
                label: U.outsideTheImage,
              }),
            );
          },
          q = ({ attributes: e, setAttributes: t, context: o }) => {
            const { cropImages: l, hoverZoom: n, fullScreenOnClick: a } = e,
              {
            ...
            return (0, r.createElement)(
              ...
              (0, r.createElement)(
                G.PanelBody,
                { title: (0, i.__)('Gallery Navigation', 'woocommerce') },
                (0, r.createElement)(j, {
              ...
              (0, r.createElement)(
                G.PanelBody,
                { title: (0, i.__)('Media Settings', 'woocommerce') },
                (0, r.createElement)(G.ToggleControl, {
                  label: (0, i.__)('Crop images to fit', 'woocommerce'),
                  help: (0, i.__)(
                ...
                (0, r.createElement)(G.ToggleControl, {
                  label: (0, i.__)('Zoom while hovering', 'woocommerce'),
                  help: (0, i.__)(
                    'While hovering the large image will zoom in by 30%.',
                    'woocommerce',
                  ),
                  checked: n,
                  onChange: () => t({ hoverZoom: !n }),
                }),
                (0, r.createElement)(G.ToggleControl, {
                  label: (0, i.__)('Open pop-up when clicked', 'woocommerce'),
                  help: (0, i.__)(
          ...
          K = [
            [
              ...
              [
                ['woocommerce/product-gallery-thumbnails', L('lock')],
                [
                  'core/group',
                  {
                    layout: {
          ...
          Q = {
            ...
            edit: ({ clientId: e, attributes: t, setAttributes: o }) => {
              const l = (0, v.useBlockProps)({ className: V(t.nextPreviousButtonsPosition) }),
                { currentTemplateId: i, templateType: n } = (0, C.useSelect)(
                  e => ({
              ...
              return (
                (0, d.useEffect)(() => {
                  const r = ((e, t) =>
                    'wp_template_part' === t && e.includes('product-gallery')
                      ? 'full'
                      : 'standard')(i, n);
                  o({ ...t, mode: r, productGalleryClientId: e }),
                    ((e, t) => {
                      const { getBlock: o, getBlockRootClientId: r, getBlockIndex: l } = (0,
                        C.select)('core/block-editor'),
                        { moveBlockToPosition: i } = (0, C.dispatch)('core/block-editor'),
                        n = o(t);
                      if (n) {
                        const o = n.innerBlocks.length ? n.innerBlocks[0].attributes.layout : null,
                          a = y({
                            blocks: [n],
                            ...
                            findCondition(e) {
                              ...
                              return Boolean(
                                null === (t = e.innerBlocks) || void 0 === t
                                  ? void 0
                                  : t.find(
                                      e => 'woocommerce/product-gallery-large-image' === e.name,
                                    ),
                              );
                            },
                          }),
                          s = l((null == c ? void 0 : c.clientId) || ''),
                          m = l((null == a ? void 0 : a.clientId) || '');
                        if (c && a && -1 !== s && -1 !== m) {
                          O({ blocks: [a, c], lockBlocks: !1 });
                          const { thumbnailsPosition: l } = e;
                          if ((P(l, t), P(l, n.innerBlocks[0].clientId), o)) {
                            const e = I(l).orientation;
                            T({ layout: { ...o, orientation: e } }, n.innerBlocks[0]);
                          }
                          ((('bottom' === l || 'right' === l) && m < s) ||
                            ('left' === l && m > s)) &&
                            i(a.clientId, r(a.clientId) || void 0, r(c.clientId) || void 0, s),
                            O({ blocks: [a, c], lockBlocks: !0 });
                        }
                      }
                    })(t, e);
                }, [o, t, e, i, n]),
                (0, r.createElement)(
                  ...
                  (0, r.createElement)(v.InnerBlocks, {
                    allowedBlocks: [
                      'woocommerce/product-gallery-large-image',
            ...
            save: ({ attributes: e }) => {
              const t = v.useBlockProps.save({
                  className: c()('wc-block-product-gallery', V(e.nextPreviousButtonsPosition)),
                }),
                o = v.useInnerBlocksProps.save(t);
              return (0, r.createElement)('div', { ...o });
            },
          },
          X = JSON.parse(
          ...
          Y = {
            [X.name]: {
              blockMetadata: X,
              blockSettings: Q,
              allowedTemplates: { 'single-product': !0 },
              allowedTemplateParts: { 'product-gallery': !0 },
              availableInPostOrPageEditor: !1,
              isVariationBlock: !1,
            },
          };
        class ee {
          constructor() {
            (0, u.A)(this, 'unregisteredBlocks', []),
              (0, u.A)(this, 'blockRegistrationStrategy', void 0),
              (this.blockRegistrationStrategy = new b());
          }
          shouldBlockBeRegistered({
            blockWithRestrictionName: e,
            currentTemplateId: t,
            isPostOrPage: o,
          }) {
            const {
                allowedTemplates: r,
                allowedTemplateParts: l,
                availableInPostOrPageEditor: i,
              } = Y[e],
              n = Object.keys(r).some(e => t.startsWith(e)),
              a = Object.keys(l).some(e => t.startsWith(e));
            return n || a || (o && i);
          }
          unregisterBlocksBeforeEnteringRestrictedArea({ currentTemplateId: e, isPostOrPage: t }) {
            for (const o of Object.keys(Y))
              this.shouldBlockBeRegistered({
                blockWithRestrictionName: o,
                currentTemplateId: e,
                isPostOrPage: t,
              }) ||
                ((0, l.getBlockType)(o) &&
                  ((this.blockRegistrationStrategy = Y[o].isVariationBlock ? new k() : new b()),
                  this.blockRegistrationStrategy.unregister(o),
                  this.unregisteredBlocks.push(o)));
          }
          registerBlocksAfterLeavingRestrictedArea() {
            for (const e of this.unregisteredBlocks) {
              const t = Y[e];
              this.blockRegistrationStrategy = Y[e].isVariationBlock ? new k() : new b();
              const o = this.blockRegistrationStrategy.register(t.blockMetadata, t.blockSettings);
              this.unregisteredBlocks = o
                ? this.unregisteredBlocks.filter(t => t !== e)
          ...
          run(e) {
            this.registerBlocksAfterLeavingRestrictedArea(),
              this.unregisterBlocksBeforeEnteringRestrictedArea({
                currentTemplateId: e.getCurrentTemplateId() || '',
                isPostOrPage: e.getIsPostOrPage(),
              });
          }
        }
        const te = window.wc.wcTypes;
        class oe {
          constructor() {
            (0, u.A)(this, 'previousTemplateId', void 0),
              (0, u.A)(this, 'currentTemplateId', void 0),
              (0, u.A)(this, 'isPostOrPage', void 0),
              (0, u.A)(this, 'observers', []),
              (this.isPostOrPage = !1),
              (0, C.subscribe)(() => {
          ...
          notify() {
            for (const e of this.observers) e.run(this);
          }
          getPreviousTemplateId() {
          ...
          parseTemplateId(e) {
            return (0, te.isNumber)(e) ? String(e) : null == e ? void 0 : e.split('//')[1];
          }
          checkIfTemplateHasChangedAndNotifySubscribers() {
            var e, t;
            this.previousTemplateId = this.currentTemplateId;
            const o =
              null === (e = (0, C.select)('core/editor')) || void 0 === e
                ? void 0
                : e.getCurrentPostId();
            this.isPostOrPage = Boolean(o);
            const r =
              o ||
              (null === (t = (0, C.select)('core/edit-site')) || void 0 === t
                ? void 0
                : t.getEditedPostId());
            this.currentTemplateId = this.parseTemplateId(r);
            const l = this.previousTemplateId !== this.currentTemplateId,
              i = Boolean(this.currentTemplateId);
            l && i && this.notify();
          }
        }
        f()(() => {
          ...
          (0, l.setCategories)([
            ...(0, l.getCategories)().filter(
              ({ slug: e }) => 'woocommerce' !== e && 'woocommerce-product-elements' !== e,
            ),
            {
              slug: 'woocommerce',
              title: (0, i.__)('WooCommerce', 'woocommerce'),
              icon: (0, r.createElement)(m.A, { icon: s }),
            },
            {
              slug: 'woocommerce-product-elements',
              title: (0, i.__)('WooCommerce Product Elements', 'woocommerce'),
              icon: (0, r.createElement)(m.A, {
                icon: s,
    ...
    (i.O = (t, o, r, l) => {
      if (!o) {
        ...
        for (m = 0; m < e.length; m++) {
          for (var [o, r, l] = e[m], a = !0, c = 0; c < o.length; c++)
  ...
  var n = i.O(void 0, [94], () => i(2314));
  (n = i.O(n)), (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['wc-blocks'] = n);
})();
