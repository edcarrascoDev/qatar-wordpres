  ...
  [4857],
  {
    28152: (e, c, t) => {
      ...
      const r = ({ children: e, className: c }) => {
        const { cartItems: t, cartIsLoading: r } = (0, n.V)();
        return (
          (0, s.useEffect)(() => {
            0 !== t.length ||
              r ||
              (0, o.Pt)('wc-blocks_render_blocks_frontend', {
                element: document.body.querySelector('.wp-block-woocommerce-cart'),
              });
          }, [r, t]),
          r || 0 !== t.length ? null : (0, l.createElement)('div', { className: c }, e)
        );
      };
    },
  },
