(() => {
        ...
        const u = e => !(e => null === e)(e) && e instanceof Object && e.constructor === Object,
          ...
          w = () =>
            (0, r.createElement)(
              h.Placeholder,
              {
                icon: (0, r.createElement)(c.A, { icon: l.A }),
                label: (0, i.__)('Product Categories List', 'woocommerce'),
          ...
          g = ({ attributes: e, setAttributes: t, name: o }) => {
            ...
            return (0, r.createElement)(
                  ...
                  (0, r.createElement)(
                    ...
                    (0, r.createElement)(
                      h.__experimentalToggleGroupControl,
                      {
                        ...
                        value: d ? 'dropdown' : 'list',
                        onChange: e => t({ isDropdown: 'dropdown' === e }),
                      },
                      (0, r.createElement)(h.__experimentalToggleGroupControlOption, {
                        value: 'list',
                        label: (0, i.__)('List', 'woocommerce'),
                      }),
                      (0, r.createElement)(h.__experimentalToggleGroupControlOption, {
                        value: 'dropdown',
                        label: (0, i.__)('Dropdown', 'woocommerce'),
                      }),
                    ),
                  ),
                  (0, r.createElement)(
                    ...
                    (0, r.createElement)(h.ToggleControl, {
                      label: (0, i.__)('Show product count', 'woocommerce'),
                      checked: o,
                      onChange: () => t({ hasCount: !o }),
                    }),
                    !d &&
                      (0, r.createElement)(h.ToggleControl, {
                        label: (0, i.__)('Show category images', 'woocommerce'),
                        help: a
                          ? (0, i.__)('Category images are visible.', 'woocommerce')
                          : (0, i.__)('Category images are hidden.', 'woocommerce'),
                        checked: a,
                        onChange: () => t({ hasImage: !a }),
                      }),
                    (0, r.createElement)(h.ToggleControl, {
                      label: (0, i.__)('Show hierarchy', 'woocommerce'),
                      checked: p,
                      onChange: () => t({ isHierarchical: !p }),
                    }),
                    (0, r.createElement)(h.ToggleControl, {
                      label: (0, i.__)('Show empty categories', 'woocommerce'),
                      checked: c,
                      onChange: () => t({ hasEmpty: !c }),
                    }),
                    (l || n) &&
                      (0, r.createElement)(h.ToggleControl, {
              ...
              (0, r.createElement)(
                h.Disabled,
                null,
                (0, r.createElement)(p(), { block: o, attributes: e, EmptyResponsePlaceholder: w }),
              ),
            );
          };
            ...
            from: [
              {
                ...
                isMatch: ({ idBase: e, instance: t }) =>
                  'woocommerce_product_categories' === e && !(null == t || !t.raw),
                transform: ({ instance: e }) =>
                  (0, a.createBlock)('woocommerce/product-categories', {
    ...
    (c.O = (t, o, r, a) => {
      if (!o) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [o, r, a] = e[d], n = !0, s = 0; s < o.length; s++)
            (!1 & a || l >= a) && Object.keys(c.O).every(e => c.O[e](o[s]))
              ? o.splice(s--, 1)
              : ((n = !1), a < l && (l = a));
          if (n) {
            e.splice(d--, 1);
  ...
  (l = c.O(l)),
    (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['product-categories'] = l);
})();
