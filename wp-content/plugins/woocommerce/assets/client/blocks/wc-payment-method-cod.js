        ...
        e.exports = (function() {
          ...
          return (function t() {
            ...
            var he,
              ...
              Ae = $,
              Se = null,
              _e = k({}, [].concat(r(D), r(R), r(C), r(F), r(H))),
              xe = null,
              ...
              mt = function(t) {
                (ct && ct === t) ||
                  ...
                  ($e = 'FORBID_CONTENTS' in t ? k({}, t.FORBID_CONTENTS, ge) : Ke),
                  (Oe = 'FORBID_TAGS' in t ? k({}, t.FORBID_TAGS, ge) : {}),
                  (Me = 'FORBID_ATTR' in t ? k({}, t.FORBID_ATTR, ge) : {}),
                  ...
                  Ve &&
                    ((Se = k({}, r(H))),
                    (xe = []),
                    !0 === Ve.html && (k(Se, D), k(xe, z)),
                    !0 === Ve.svg && (k(Se, R), k(xe, P), k(xe, B)),
                    !0 === Ve.svgFilters && (k(Se, C), k(xe, P), k(xe, B)),
                    !0 === Ve.mathMl && (k(Se, F), k(xe, j), k(xe, B))),
                  t.ADD_TAGS && (Se === _e && (Se = O(Se)), k(Se, t.ADD_TAGS, ge)),
                  t.ADD_ATTR && (xe === Le && (xe = O(xe)), k(xe, t.ADD_ATTR, ge)),
                  t.ADD_URI_SAFE_ATTR && k(Je, t.ADD_URI_SAFE_ATTR, ge),
                  t.FORBID_CONTENTS && ($e === Ke && ($e = O($e)), k($e, t.FORBID_CONTENTS, ge)),
                  qe && (Se['#text'] = !0),
            ...
            var yt = function(e) {
              ...
              wt = function(e) {
                ...
                var r = ge(e.nodeName);
                if (
                  (Nt('uponSanitizeElement', e, { tagName: r, allowedTags: Se }),
                  e.hasChildNodes() &&
                ...
                if (!Se[r] || Oe[r]) {
                  if (!Oe[r] && St(r)) {
                    if (ke.tagNameCheck instanceof RegExp && _(ke.tagNameCheck, r)) return !1;
              ...
              At = function(e, t, n) {
                ...
                if (Re && !Me[t] && _(Te, t));
                  ...
                  if (
                    !(
                      (St(e) &&
                        ((ke.tagNameCheck instanceof RegExp && _(ke.tagNameCheck, e)) ||
                          (ke.tagNameCheck instanceof Function && ke.tagNameCheck(e))) &&
                        ((ke.attributeNameCheck instanceof RegExp && _(ke.attributeNameCheck, t)) ||
                          (ke.attributeNameCheck instanceof Function &&
                            ke.attributeNameCheck(t)))) ||
                      ('is' === t &&
                        ke.allowCustomizedBuiltInElements &&
                        ((ke.tagNameCheck instanceof RegExp && _(ke.tagNameCheck, n)) ||
  ...
  (n.n = e => {
    ...
    (() => {
      ...
      const c = ['a', 'b', 'em', 'i', 'strong', 'p', 'br'],
        ...
        u = window.wp.element;
      var m;
      const p = (0, o.getPaymentMethodData)('cod', {}),
        f = (0, r.__)('Cash on delivery', 'woocommerce'),
        d = (0, a.decodeEntities)((null == p ? void 0 : p.title) || '') || f,
        h = () =>
          (0, e.createElement)(
            u.RawHTML,
            null,
        ...
        g = {
          ...
          canMakePayment: ({ cartNeedsShipping: e, selectedShippingMethods: t }) => {
            if (!p.enableForVirtual && !e) return !1;
            if (!p.enableForShippingMethods.length) return !0;
            const n = Object.values(t);
            return p.enableForShippingMethods.some(e => n.some(t => t.includes(e)));
          },
          ariaLabel: d,
          supports: {
            features: null !== (m = null == p ? void 0 : p.supports) && void 0 !== m ? m : [],
          },
        };
