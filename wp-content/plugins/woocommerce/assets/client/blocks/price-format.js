(() => {
  ...
  var e = {
      d: (r, t) => {
        for (var o in t)
          e.o(t, o) && !e.o(r, o) && Object.defineProperty(r, o, { enumerable: !0, get: t[o] });
      },
    ...
    r = {};
  e.r(r),
    e.d(r, { formatPrice: () => s, getCurrency: () => c, getCurrencyFromPriceResponse: () => a });
  const t = window.wc.wcSettings,
    o = {
      ...
      prefix:
        ((i = t.CURRENCY.symbol),
        (n = t.CURRENCY.symbolPosition),
        { left: i, left_space: ' ' + i, right: '', right_space: '' }[n] || ''),
      suffix: ((e, r) => ({ left: '', left_space: '', right: e, right_space: ' ' + e }[r] || ''))(
        t.CURRENCY.symbol,
        t.CURRENCY.symbolPosition,
      ),
    };
  var i, n;
  const a = e => {
    ...
    s = (e, r) => {
      ...
      const o = c(r),
        { minorUnit: i, prefix: n, suffix: a, decimalSeparator: s, thousandSeparator: u } = o,
        p = t / 10 ** i,
        { beforeDecimal: l, afterDecimal: f } = (e => {
          const r = e.split('.');
          return { beforeDecimal: r[0], afterDecimal: r[1] || '' };
        })(p.toString()),
        m = `${n}${((e, r) => e.replace(/\B(?=(\d{3})+(?!\d))/g, r))(l, u)}${((e, r, t) =>
          e ? `${r}${e.padEnd(t, '0')}` : t > 0 ? `${r}${'0'.repeat(t)}` : '')(f, s, i)}${a}`,
