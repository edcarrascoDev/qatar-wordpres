(() => {
    ...
    n = {
      7235: (e, t, o) => {
        ...
        const _ = () =>
          ...
          O = (0, y.forwardRef)((e, t) => {
            ...
            const {
              ...
              l = u()('wc-block-components-button', 'wp-element-button', o, c, {
                'wc-block-components-button--loading': r,
              });
            if ('href' in e)
              return (0, n.createElement)(k.$, {
                render: (0, n.createElement)(
                  'a',
                  { ref: t, href: e.href },
                  r && (0, n.createElement)(_, null),
                  (0, n.createElement)(
                    'span',
        ...
        const M = ({
          ...
          ((e, t) => {
            const o = 'string' == typeof e ? e : (0, y.renderToString)(e);
            (0, y.useEffect)(() => {
              o && (0, x.speak)(o, t);
            }, [o, t]);
          })(r, i),
          (0, n.createElement)(
            'div',
            {
              className: u()(e, 'wc-block-components-notice-banner', 'is-' + t, {
                'is-dismissible': a,
              }),
            },
            (0, n.createElement)(s.A, { icon: b(t) }),
            (0, n.createElement)(
              'div',
            ...
            !!a &&
              (0, n.createElement)(
                ...
                (0, n.createElement)(s.A, { icon: d.A }),
              ),
          )
        );
        o(6363);
        (0, r.registerBlockType)(i, {
          ...
          edit: () => {
            const e = (0, l.useBlockProps)({ className: 'wc-block-store-notices' });
            return (0, n.createElement)(
              'div',
              { ...e },
              (0, n.createElement)(
  ...
  function s(e) {
    ...
    var o = (r[e] = { exports: {} });
    return n[e].call(o.exports, o, o.exports, s), o.exports;
  }
  (s.m = n),
    (e = []),
    (s.O = (t, o, n, r) => {
      if (!o) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [o, n, r] = e[p], a = !0, i = 0; i < o.length; i++)
            (!1 & r || c >= r) && Object.keys(s.O).every(e => s.O[e](o[i]))
              ? o.splice(i--, 1)
              : ((a = !1), r < c && (c = r));
          if (a) {
            e.splice(p--, 1);
    ...
    (s.d = (e, t) => {
      for (var o in t)
        s.o(t, o) && !s.o(e, o) && Object.defineProperty(e, o, { enumerable: !0, get: t[o] });
    }),
    ...
    (() => {
      ...
      var t = (t, o) => {
          ...
          for (t && t(o); l < c.length; l++) (r = c[l]), s.o(e, r) && e[r] && e[r][0](), (e[r] = 0);
          return s.O(p);
        },
  ...
  var c = s.O(void 0, [94], () => s(7235));
  (c = s.O(c)), (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['store-notices'] = c);
})();
