(() => {
    ...
    r = {
      5287: (e, t, o) => {
        ...
        const _ = (0, i.getSetting)('wcBlocksConfig', {
          ...
          v = _.pluginUrl + 'assets/images/',
          f = (_.pluginUrl, _.buildPhase),
          E =
            (null === (s = i.STORE_PAGES.shop) || void 0 === s || s.permalink,
            null === (d = i.STORE_PAGES.checkout) || void 0 === d || d.id,
            null === (u = i.STORE_PAGES.checkout) || void 0 === u || u.permalink,
            null === (p = i.STORE_PAGES.privacy) || void 0 === p || p.permalink,
            null === (m = i.STORE_PAGES.privacy) || void 0 === m || m.title,
            null === (C = i.STORE_PAGES.terms) || void 0 === C || C.permalink,
            null === (w = i.STORE_PAGES.terms) || void 0 === w || w.title,
            null === (g = i.STORE_PAGES.cart) || void 0 === g || g.id,
            null === (b = i.STORE_PAGES.cart) || void 0 === b || b.permalink,
            null !== (h = i.STORE_PAGES.myaccount) && void 0 !== h && h.permalink
        ...
        var A = o(7723),
          ...
          j = o(8107),
          M = o(4717);
        const G = ['BUTTON', 'FIELDSET', 'INPUT', 'OPTGROUP', 'OPTION', 'SELECT', 'TEXTAREA', 'A'],
          H = ({ children: e, style: t = {}, ...o }) => {
            const l = (0, R.useRef)(null),
              n = () => {
                l.current &&
                  j.focus.focusable.find(l.current).forEach(e => {
                    G.includes(e.nodeName) && e.setAttribute('tabindex', '-1'),
                      e.hasAttribute('contenteditable') &&
                        e.setAttribute('contenteditable', 'false');
                  });
              },
              c = (0, M.YQ)(n, 0, { leading: !0 });
            return (
              (0, R.useLayoutEffect)(() => {
                let e;
                return (
                  ...
                  l.current &&
                    ...
                    e.observe(l.current, { childList: !0, attributes: !0, subtree: !0 })),
                  () => {
          ...
          F = ({ colorTypes: e }) => {
            const t = (0, T.__experimentalUseMultipleOriginColorsAndGradients)(),
              o = (e => {
                const t = [];
                return (
                  e.colors &&
              ...
              { clientId: l } = (0, T.useBlockEditContext)(),
              n = (0, V.useSelect)(
                e => {
                  const { getBlockAttributes: t } = e(T.store);
                  return t(l) || {};
                },
                [l],
              ),
              { updateBlockAttributes: c } = (0, V.useDispatch)(T.store),
              a = (0, R.useMemo)(
                () =>
                  ((e, t, o, r) =>
                    Object.entries(e).reduce((e, [l, n]) => {
                      var c, a;
                      const i = ((e, t, o, r) => l => {
                          const n =
                            ((e, t, o) => {
                              if (!t) return;
                              const r =
                                (null == e ? void 0 : e.find(e => e.color === t || e.slug === t)) ||
                                {};
                              return (
                                (null != r && r.color) || (r.color = t),
                                (r.class = (0, T.getColorClassName)(
                                  o,
                                  null == r ? void 0 : r.slug,
                                )),
                                r
                              );
                            })(o, l, t) || {};
            ...
            return (
              ...
              (0, r.createElement)(
                T.InspectorControls,
                { group: 'color' },
                (0, r.createElement)(T.__experimentalColorGradientSettingsDropdown, {
        ...
        o(880);
        const I = ({ count: e, icon: t, iconColor: o, productCountColor: l }) =>
            (0, r.createElement)(
              'span',
              ...
              (0, r.createElement)(
                'span',
                { className: 'wc-block-mini-cart__badge', style: { background: l.color } },
                e > 0 ? e : '',
              ),
            ),
          Z = { name: void 0, color: void 0, slug: void 0 };
        window.wc.wcTypes, window.wp.apiFetch, o(1512);
        o(106);
        const D = {
          ...S.supports,
          ...(f > 1 && {
        ...
        (0, a.registerBlockType)(S, {
          ...
          edit: ({ attributes: e, setAttributes: t }) => {
            const {
                cartAndCheckoutRenderStyle: o,
                addToCartBehaviour: l,
                hasHiddenPrice: n,
                priceColor: a = Z,
                iconColor: s = Z,
                productCountColor: d = Z,
                miniCartIcon: u,
              } = (function(e) {
                const t = { ...e };
                return (
                  t.priceColorValue &&
                    !t.priceColor &&
                    ((t.priceColor = { color: e.priceColorValue }), delete t.priceColorValue),
                  t.iconColorValue &&
                    !t.iconColor &&
                    ((t.iconColor = { color: e.iconColorValue }), delete t.iconColorValue),
                  t.productCountColorValue &&
                    !t.productCountColor &&
                    ((t.productCountColor = { color: e.productCountColorValue }),
                    delete t.productCountColorValue),
                  t
                );
              })(e),
              p = {
                priceColor: { label: (0, A.__)('Price', 'woocommerce'), context: 'price-color' },
                iconColor: { label: (0, A.__)('Icon', 'woocommerce'), context: 'icon-color' },
                productCountColor: {
                  label: (0, A.__)('Product Count', 'woocommerce'),
                  context: 'product-count-color',
                },
              },
              m = (0, T.useBlockProps)({ className: 'wc-block-mini-cart' }),
              C = (e => {
                if (
                  !(e => null === e)((t = e)) &&
                  t instanceof Object &&
                ...
                var t;
                return !1;
              })((0, V.select)('core/edit-site')),
              w = (0, i.getSetting)('templatePartEditUri', '');
                ...
                (0, r.createElement)(
                  ...
                  (0, r.createElement)(
                    P.__experimentalToggleGroupControl,
                    {
                      ...
                      isBlock: !0,
                      label: (0, A.__)('Cart Icon', 'woocommerce'),
                      value: u,
                      onChange: e => {
                        t({ miniCartIcon: e });
                      },
                    ...
                    (0, r.createElement)(P.__experimentalToggleGroupControlOption, {
                      value: 'cart',
                      label: (0, r.createElement)(c.A, { size: 32, icon: B }),
                    }),
                    (0, r.createElement)(P.__experimentalToggleGroupControlOption, {
                      value: 'bag',
                      label: (0, r.createElement)(c.A, { size: 32, icon: L }),
                    }),
                    (0, r.createElement)(P.__experimentalToggleGroupControlOption, {
                      value: 'bag-alt',
                      label: (0, r.createElement)(c.A, { size: 32, icon: N }),
                    }),
                  ),
                  (0, r.createElement)(
                    P.BaseControl,
                    ...
                    (0, r.createElement)(P.ToggleControl, {
                      label: (0, A.__)('Display total price', 'woocommerce'),
                      help: (0, A.__)(
                  ...
                  C &&
                    (0, r.createElement)(
                      P.__experimentalToggleGroupControl,
                      {
                        ...
                        label: (0, A.__)('Mini-Cart in cart and checkout pages', 'woocommerce'),
                        value: o,
                        onChange: e => {
                          t({ cartAndCheckoutRenderStyle: e });
                        },
                        help: (0, A.__)(
                      ...
                      (0, r.createElement)(P.__experimentalToggleGroupControlOption, {
                        value: 'hidden',
                        label: (0, A.__)('Hide', 'woocommerce'),
                      }),
                      (0, r.createElement)(P.__experimentalToggleGroupControlOption, {
                        value: 'removed',
                        label: (0, A.__)('Remove', 'woocommerce'),
                      }),
                    ),
                ),
                (0, r.createElement)(
                  P.PanelBody,
                  { title: (0, A.__)('Cart Drawer', 'woocommerce') },
                  w &&
                    (0, r.createElement)(
                      r.Fragment,
                      null,
                      (0, r.createElement)('img', {
                        ...
                        src: (0, A.isRTL)()
                          ? `${v}blocks/mini-cart/cart-drawer-rtl.svg`
                          : `${v}blocks/mini-cart/cart-drawer.svg`,
                        alt: '',
                      }),
                      (0, r.createElement)(
                        'p',
                      ...
                      (0, r.createElement)(
                        'p',
                        { className: 'wc-block-editor-mini-cart__drawer-link' },
                        (0, r.createElement)(
                          P.ExternalLink,
                          { href: w },
                          (0, A.__)('Edit Mini-Cart Drawer template', 'woocommerce'),
                        ),
                      ),
                    ),
                  (0, r.createElement)(
                    P.BaseControl,
                    {
                      ...
                      label: (0, A.__)('Behavior', 'woocommerce'),
                    },
                    (0, r.createElement)(P.ToggleControl, {
                      label: (0, A.__)('Open drawer when adding', 'woocommerce'),
                      onChange: e => {
                        t({ addToCartBehaviour: e ? 'open_drawer' : 'none' });
                      },
                      help: (0, A.__)(
                        'Toggle to open the Mini-Cart drawer when a shopper adds a product to their cart.',
                        'woocommerce',
                      ),
                      checked: 'open_drawer' === l,
                    }),
                  ),
                ),
              ),
              (0, r.createElement)(F, { colorTypes: p }),
              (0, r.createElement)(
                H,
                null,
                (0, r.createElement)(
                  ...
                  !n &&
                    (0, r.createElement)(
                      'span',
                      { className: 'wc-block-mini-cart__amount', style: { color: a.color } },
                      (0, x.formatPrice)(0),
                    ),
                  (0, r.createElement)(I, {
                    count: 0,
          ...
          (0, O.addFilter)('blocks.registerBlockType', 'woocommerce/mini-cart', function(e, t) {
            return 'core/template-part' === t
              ? {
                  ...e,
                  variations: e.variations.map(e =>
                    'mini-cart' === e.name ? { ...e, scope: [] } : e,
                  ),
                }
              : e;
          });
  ...
  (n.m = r),
    ...
    (n.O = (t, o, r, l) => {
      if (!o) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [o, r, l] = e[d], a = !0, i = 0; i < o.length; i++)
            (!1 & l || c >= l) && Object.keys(n.O).every(e => n.O[e](o[i]))
              ? o.splice(i--, 1)
              : ((a = !1), l < c && (c = l));
          if (a) {
            e.splice(d--, 1);
    ...
    (() => {
      ...
      var t = (t, o) => {
          ...
          for (t && t(o); s < c.length; s++) (l = c[s]), n.o(e, l) && e[l] && e[l][0](), (e[l] = 0);
          return n.O(d);
        },
  ...
  var c = n.O(void 0, [94], () => n(5287));
  (c = n.O(c)), (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['mini-cart'] = c);
})();
