(() => {
    ...
    o = {
      2699: (e, t, r) => {
        ...
        (0, l.registerBlockType)(i, {
          ...
          edit: () => {
            const e = (0, s.useBlockProps)({ className: 'wc-block-order-confirmation-totals' }),
              {
                borderBottomColor: t,
                borderLeftColor: r,
                borderRightColor: l,
                ...
                (0, o.createElement)(
                  ...
                  (0, o.createElement)(
                    ...
                    (0, o.createElement)(
                      ...
                      (0, o.createElement)(
                        'th',
                        { className: 'wc-block-order-confirmation-totals__total' },
                        (0, d.__)('Total', 'woocommerce'),
                      ),
                    ),
                  ),
                  (0, o.createElement)(
                    ...
                    (0, o.createElement)(
                      ...
                      (0, o.createElement)(
                        'th',
                        { scope: 'row', className: 'wc-block-order-confirmation-totals__product' },
                        (0, o.createElement)(
                          'a',
                          { href: '#link' },
                        ...
                        ' ',
                        (0, o.createElement)('strong', { className: 'product-quantity' }, '× 2'),
                      ),
                      (0, o.createElement)(
                        'td',
                        { className: 'wc-block-order-confirmation-totals__total' },
                  ...
                  (0, o.createElement)(
                    ...
                    (0, o.createElement)(
                      ...
                      (0, o.createElement)(
                        'th',
                        { className: 'wc-block-order-confirmation-totals__label', scope: 'row' },
                        (0, d.__)('Total', 'woocommerce'),
                      ),
                      (0, o.createElement)(
                        'td',
  ...
  (a.m = o),
    ...
    (a.O = (t, r, o, l) => {
      if (!r) {
        ...
        for (m = 0; m < e.length; m++) {
          for (var [r, o, l] = e[m], n = !0, i = 0; i < r.length; i++)
            (!1 & l || c >= l) && Object.keys(a.O).every(e => a.O[e](r[i]))
              ? r.splice(i--, 1)
              : ((n = !1), l < c && (c = l));
          if (n) {
            e.splice(m--, 1);
    ...
    (() => {
      ...
      var t = (t, r) => {
          ...
          for (t && t(r); s < c.length; s++) (l = c[s]), a.o(e, l) && e[l] && e[l][0](), (e[l] = 0);
          return a.O(m);
        },
  ...
  var c = a.O(void 0, [94], () => a(2699));
  (c = a.O(c)),
    (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['order-confirmation-totals'] = c);
})();
