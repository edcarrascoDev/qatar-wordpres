  ...
  [3644],
  {
    8593: (e, t, r) => {
          ...
          (0, c.createElement)(
            ...
            (0, c.createElement)(s.FormattedMonetaryAmount, {
              ...
              renderText: e =>
                (0, c.createElement)(
                  'del',
                  { className: o()('wc-block-components-product-price__regular', t), style: r },
                  e,
                ),
              value: n,
            }),
        ...
        d = ({
          ...
          return (
            b
              ...
              : i &&
                (N = (0, c.createElement)(s.FormattedMonetaryAmount, {
                  className: o()('wc-block-components-product-price__value', d),
                  currency: r,
                  value: i,
                  style: _,
            ...
            (0, c.createElement)(
              'span',
              { className: k, style: w },
              (0, m.createInterpolateElement)(a, { price: N }),
            )
          );
        };
      var _ = r(8537);
      ...
      const y = ({
        ...
        if (t) {
          ...
          return (0, c.createElement)('span', {
            className: p,
            ...e,
            dangerouslySetInnerHTML: { __html: (0, _.decodeEntities)(r) },
          });
        }
      ...
      const N = ({ children: e, className: t }) =>
        ...
        f = ({ image: e = {}, fallbackAlt: t = '' }) => {
          const r = e.thumbnail
            ? { src: e.thumbnail, alt: (0, _.decodeEntities)(e.alt) || t || 'Product Image' }
            : { src: w.PLACEHOLDER_IMG_SRC, alt: '' };
          return (0, c.createElement)('img', { ...r, alt: r.alt });
        },
        h = ({ lowStockRemaining: e }) =>
          e
            ? (0, c.createElement)(
                N,
                { className: 'wc-block-components-product-low-stock-badge' },
                (0,
                a.sprintf) /* translators: %d stock amount (number of items in stock for product) */(
                  /* translators: %d stock amount (number of items in stock for product) */
                  (0, a.__)('%d left in stock', 'woocommerce'),
                  e,
                ),
              )
            : null;
                ...
                e.map(e => {
                  const t = (null == e ? void 0 : e.key) || e.name || '',
                    r =
                      ...
                      (t ? `wc-block-components-product-details__${(0, P.c)(t)}` : '');
      ...
      const S = ({
        ...
        const s = (0, m.useMemo)(
          () =>
            ((e, t = 15, r = 'words') => {
              const c = (0, x.autop)(e);
              if ((0, F.count)(c, r) <= t) return c;
              const a = (e => {
                const t = e.indexOf('</p>');
                return -1 === t ? e : e.substr(0, t + 4);
              })(c);
              return (0, F.count)(a, r) <= t
                ? a
                : 'words' === r
                ? ((e, t, r = '&hellip;', c = !0) => {
                    const a = I(e),
                ...
                : ((e, t, r = !0, c = '&hellip;', a = !0) => {
                    ...
                    if (r) return (0, x.autop)(A(s, c));
                    const l = s.match(/([\s]+)/g),
                      o = l ? l.length : 0,
                      i = n.slice(0, t + o);
                    return a ? (0, x.autop)(A(i, c)) : A(i, c);
                  })(a, t, 'characters_including_spaces' === r);
            })(e, t, r),
          [e, t, r],
        );
        return (0, c.createElement)(m.RawHTML, { style: n, className: a }, s);
      };
      var D = r(812);
      const T = ({ className: e, shortDescription: t = '', fullDescription: r = '' }) => {
        const a = t || r;
        return a
          ? (0, c.createElement)(S, {
              className: e,
              source: a,
              maxLength: 15,
              countType: D.r7.wordCountType || 'words',
            })
          : null;
      };
      r(401);
      const M = ({
        ...
        $ = ({ cartItem: e }) => {
          const {
            ...
            { receiveCart: F, ...S } = (0, k.V)(),
            D = (0, m.useMemo)(() => ({ context: 'summary', cartItem: e, cart: S }), [e, S]),
            T = (0, i.getCurrencyFromPriceResponse)(u),
            $ = (0, E.applyCheckoutFilter)({
              filterName: 'itemName',
              defaultValue: l,
              extensions: A,
              arg: D,
            ...
            L = (0, g.A)({
              ...
              precision: (0, b.isString)(u.raw_prices.precision)
                ? parseInt(u.raw_prices.precision, 10)
                : u.raw_prices.precision,
            })
              .convertPrecision(T.minorUnit)
              .getAmount(),
            R = (0, g.A)({
              ...
              .convertPrecision(T.minorUnit)
              .getAmount(),
            V = (0, i.getCurrencyFromPriceResponse)(I);
          let H = parseInt(I.line_subtotal, 10);
          (0, w.getSetting)('displayCartPricesIncludingTax', !1) &&
            (H += parseInt(I.line_subtotal_tax, 10));
          const O = (0, g.A)({ amount: H, precision: V.minorUnit }).getAmount(),
          ...
          return (0, c.createElement)(
            ...
            (0, c.createElement)(
              ...
              (0, c.createElement)(
                ...
                (0, c.createElement)(s.Label, {
                  label: _.toString(),
                  screenReaderLabel: (0,
                  a.sprintf) /* translators: %d number of products of the same type in the cart */(
                    /* translators: %d number of products of the same type in the cart */
                    (0, a._n)('%d item', '%d items', _, 'woocommerce'),
                    _,
                  ),
                }),
              ),
              (0, c.createElement)(f, { image: t.length ? t[0] : {}, fallbackAlt: $ }),
            ),
            (0, c.createElement)(
              'div',
              { className: 'wc-block-components-order-summary-item__description' },
              (0, c.createElement)(y, { disabled: !0, name: $, permalink: p }),
              (0, c.createElement)(d, {
                currency: T,
                price: R,
                regularPrice: L,
              ...
              n
                ? (0, c.createElement)(v, null)
                : !!r && (0, c.createElement)(h, { lowStockRemaining: r }),
              (0, c.createElement)(M, {
                shortDescription: N,
                fullDescription: P,
                itemData: C,
            ...
            (0, c.createElement)(
              ...
              { className: 'screen-reader-text' },
              (0,
              a.sprintf) /* translators: %1$d is the number of items, %2$s is the item name and %3$s is the total price including the currency symbol. */(
            ...
            (0, c.createElement)(
              ...
              (0, c.createElement)(d, { currency: V, format: B, price: O }),
            ),
          );
        };
      r(5415);
      const L = ({ cartItems: e = [] }) => {
          const { isLarge: t, hasContainerWidth: r } = (0, n.G)();
          return r
            ? (0, c.createElement)(
                s.Panel,
                {
                  ...
                  title: (0, c.createElement)(
                    ...
                    (0, a.__)('Order summary', 'woocommerce'),
                  ),
                },
                (0, c.createElement)(
                  'div',
                  { className: 'wc-block-components-order-summary__content' },
                  e.map(e => (0, c.createElement)($, { key: e.key, cartItem: e })),
                ),
              )
            : null;
        },
        R = ({ className: e = '' }) => {
          const { cartItems: t } = (0, k.V)();
          return (0, c.createElement)(
            s.TotalsWrapper,
            { className: e },
            (0, c.createElement)(L, { cartItems: t }),
          );
        };
    },
    5415: () => {},
