  ...
  [2996],
  {
    ...
    4597: (e, t, o) => {
      ...
      const g = ({
        ...
        const b = (0, s.useRef)(null),
          ...
          { error: A, validationErrorId: R } = (0, u.useSelect)(e => {
      ...
      const _ = ({
        ...
        v = ({
          ...
          const { extensions: C, receiveCart: w, ...y } = (0, i.V)(),
            ...
            { isEditor: R } = (0, p.m)(),
            { hasSelectedLocalPickup: N, selectedRates: S } = (0, d.m)(),
            I = (0, m.isObject)(S) ? Object.values(S) : [],
            O = I.every(e => e === I[0]);
          return (0, n.createElement)(
            r.A,
            {
      ...
      const $ = () => {
        ...
        j = ({
          ...
          return (0, n.createElement)(
            n.Fragment,
            null,
            c ? (0, n.createElement)($, null) : (0, n.createElement)(K, { formattedLocation: h }),
            e &&
              (0, n.createElement)(D, {
                label: m,
                isShippingCalculatorOpen: t,
    ...
    5416: (e, t, o) => {
      ...
      const l = ({
        ...
        (0, n.createElement)(
          'div',
          { className: r()(t, { 'wc-block-components-loading-mask': l }) },
          l && s && (0, n.createElement)(c.Spinner, null),
          (0, n.createElement)(
            'div',
            {
              className: r()({ 'wc-block-components-loading-mask__children': l }),
              'aria-hidden': l,
            },
            e,
          ),
    ...
    1533: (e, t, o) => {
      ...
      const p = () => {
          const { extensions: e, receiveCart: t, ...o } = (0, c.V)(),
            a = { extensions: e, cart: o, context: 'woocommerce/checkout' };
          return (0, n.createElement)(i.ExperimentalDiscountsMeta.Slot, { ...a });
        },
        d = ({ className: e = '' }) => {
          const { cartTotals: t, cartCoupons: o } = (0, c.V)(),
            { removeCoupon: i, isRemovingCoupon: d } = (0, l.k)('wc/checkout'),
            u = (0, r.getCurrencyFromPriceResponse)(t);
          return (0, n.createElement)(
            n.Fragment,
            null,
            (0, n.createElement)(
