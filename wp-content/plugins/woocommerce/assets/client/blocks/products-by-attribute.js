(() => {
      ...
      2518: (e, t, r) => {
        ...
        const h = (e, t, r) =>
          ...
          p = ({ onChange: e, settings: t }) => {
            const { image: r, button: n, price: a, rating: c, title: o } = t,
              i = !1 !== r;
            return (0, l.createElement)(
              ...
              (0, l.createElement)(m.ToggleControl, {
                ...
                checked: o,
                onChange: () => e({ ...t, title: !o }),
              }),
              (0, l.createElement)(m.ToggleControl, {
                label: (0, u.__)('Product price', 'woocommerce'),
                checked: a,
                onChange: () => e({ ...t, price: !a }),
              }),
              (0, l.createElement)(m.ToggleControl, {
        ...
        const _ = window.wp.htmlEntities,
          ...
          y = (e, t = e) => {
            ...
            const n = ['0'],
              a = (e = {}) => (e.parent ? [...a(l[e.parent]), e.name] : e.name ? [e.name] : []),
              c = e =>
                e.map(e => {
                  const t = r[e.id];
                  return (
                    n.push('' + e.id),
                    { ...e, breadcrumbs: a(l[e.parent]), children: t && t.length ? c(t) : [] }
                  );
                }),
              o = c(r[0] || []);
            return (
              Object.entries(r).forEach(([e, t]) => {
                n.includes(e) || o.push(...c(t || []));
              }),
              o
            );
          },
          ...
          C = ({
            ...
            var p, g;
            const [f, y] = h,
              C = null != e && void 0 !== a.count && null !== a.count,
              S = !(null === (p = a.breadcrumbs) || void 0 === p || !p.length),
              N = !(null === (g = a.children) || void 0 === g || !g.length),
              O = f === a.id,
              P = w()(['woocommerce-search-list__item', `depth-${r}`, t], {
                'has-breadcrumbs': S,
                'has-children': N,
                'has-count': C,
                'is-expanded': O,
              ...
              ? (0, l.createElement)(
                  ...
                  o
                    ? (0, l.createElement)(
                        ...
                        (0, l.createElement)(k, { item: a, search: s }),
                        C ? (0, l.createElement)(v, { label: e || a.count }) : null,
                      )
                    : (0, l.createElement)(
                        l.Fragment,
                        null,
                        (0, l.createElement)(m.CheckboxControl, {
                          className: 'woocommerce-search-list__item-input',
                          checked: c,
                          ...(!c && a.children.some(e => u.find(t => t.id === e.id))
                            ? { indeterminate: !0 }
                            : {}),
                          label: x((0, _.decodeEntities)(a.name), s),
                          onChange: () => {
                            c
                              ? i(b(u, a.children, 'id'))()
                              : i(
              ...
              : (0, l.createElement)(
                  ...
                  o
                    ...
                    : (0, l.createElement)(m.CheckboxControl, {
                        ...
                        name: A,
                        className: 'woocommerce-search-list__item-input',
                        value: (0, _.decodeEntities)(a.value),
                        label: x((0, _.decodeEntities)(a.name), s),
                        onChange: i(a),
                        checked: c,
                      }),
        ...
        const A = ({
            ...
            const [i, s] = (0, d.useState)(!1),
              h = (0, O.useInstanceId)(A);
            if (((c = c || t), !t)) return null;
            t = (0, _.decodeEntities)(t);
            const E = w()('woocommerce-tag', o, { 'has-remove': !!a }),
          ...
          I = A;
        r(8137);
        const B = e => (0, l.createElement)(S, { ...e }),
          $ = e => {
            const {
                list: t,
                selected: r,
              ...
              ? (0, l.createElement)(
                  ...
                  t.map(t => {
                    ...
                    return (0, l.createElement)(
                      ...
                      g ? (0, l.createElement)($, { ...e, list: t.children, depth: a + 1 }) : null,
                    );
                  }),
                )
              : null;
          ...
          R = ({
            ...
            return (0, l.createElement)(
              ...
              (0, l.createElement)(
                ...
                (0, l.createElement)('strong', null, n.selected(o)),
                o > 0
                  ? (0, l.createElement)(
                      m.Button,
                      {
                ...
                ? (0, l.createElement)(
                    ...
                    r.map((e, t) =>
                      (0, l.createElement)(
                        'li',
                        { key: t },
                        (0, l.createElement)(I, { label: e.name, id: e.id, remove: c }),
                      ),
                    ),
                  )
                : null,
          ...
          T = ({
            ...
            const { messages: i, renderItem: s, selected: m, isSingle: d } = o,
              h = s || B;
            return 0 === e.length
              ? (0, l.createElement)(
                  'div',
                  ...
                  (0, l.createElement)(
                    ...
                    (0, l.createElement)(n.A, { icon: N.A, role: 'img' }),
                  ),
                  (0, l.createElement)(
                    'span',
          ...
          j = e => {
            ...
            return (0, l.createElement)(
              ...
              'text' === p && (0, l.createElement)(R, { ...e, onRemove: S, messages: k }),
              (0, l.createElement)(
                'div',
          ...
          L = ((0, m.withSpokenMessages)(j), window.wp.url, window.wp.apiFetch);
        var F = r.n(L);
        const M = e => F()({ path: `wc/store/v1/products/attributes/${e}/terms` });
        const D = window.wp.escapeHtml,
                ...
                e
                  ? 'general' === t
                    ? (0, l.createElement)(
                        ...
                        (0, l.createElement)('code', null, (0, D.escapeHTML)(e)),
                      )
                    : 'api' === t
                    ? (0, l.createElement)(
                        'span',
          ...
          J = window.wc.wcTypes,
          W =
            ((window.wp.data, (0, o.getSetting)('attributes', [])).reduce((e, t) => {
              const r =
            ...
            e => {
              const { count: t, id: r, name: l, parent: n } = e;
              return {
                count: t,
                id: r,
                name: l,
                ...
                breadcrumbs: [],
                children: [],
                value: (0, J.isAttributeTerm)(e) ? e.attr_slug : '',
              };
            });
        r(2777);
        const G = (0, O.withInstanceId)(
            ({
              onChange: e,
              onOperatorChange: t,
              instanceId: r,
              ...
              const {
                  errorLoadingAttributes: s,
                  isLoadingAttributes: h,
                  productsAttributes: E,
                } = (function(e) {
                  ...
                  return (
                      ...
                      if (e && !l && !o.current)
                        return (
                          (async function() {
                            n(!0);
                            try {
                              const e = await F()({ path: 'wc/store/v1/products/attributes' }),
                                t = [];
                              for (const r of e) {
                                const e = await M(r.id);
                                t.push({
                                  ...r,
                                  parent: 0,
                                  terms: e.map(e => ({
                    ...
                    { errorLoadingAttributes: t, isLoadingAttributes: l, productsAttributes: a }
                  );
                })(!0),
                p = E.reduce((e, t) => {
                  const { terms: r, ...l } = t;
                  return [...e, W(l), ...r.map(W)];
                }, []);
              return (
                (a = {
                  clear: (0, u.__)('Clear all product attributes', 'woocommerce'),
                  noItems: (0, u.__)(
                    "Your store doesn't have any product attributes.",
                    'woocommerce',
                  ),
                  search: (0, u.__)('Search for product attributes', 'woocommerce'),
                  selected: e =>
                    (0, u.sprintf) /* translators: %d is the count of attributes selected. */(
                  ...
                  updated: (0, u.__)('Product attribute search results updated.', 'woocommerce'),
                  ...a,
                }),
                s
                  ? (0, l.createElement)(H, { error: s })
                  : (0, l.createElement)(
                      l.Fragment,
                      null,
                      (0, l.createElement)(j, {
                        ...
                        onChange: e,
                        renderItem: e => {
                          const { item: t, search: n, depth: a = 0 } = e,
                            c = t.count || 0,
                            o = [
                              'woocommerce-product-attributes__item',
                              'woocommerce-search-list__item',
                              {
                                'is-searching': n.length > 0,
                                'is-skip-level': 0 === a && 0 !== t.parent,
                              },
                            ];
                          if (!t.breadcrumbs.length)
                            return (0, l.createElement)(V, {
                              ...e,
                              className: w()(o),
                              item: t,
                              isLoading: h,
                              ...
                              name: `attributes-${r}`,
                              countLabel: (0,
                              u.sprintf) /* translators: %d is the count of terms. */(
                                /* translators: %d is the count of terms. */
                                (0, u._n)('%d term', '%d terms', c, 'woocommerce'),
                                c,
                              ),
                              'aria-label': (0,
                              u.sprintf) /* translators: %1$s is the item name, %2$d is the count of terms for the item. */(
                          ...
                          return (0, l.createElement)(C, {
                            ...e,
                            name: `terms-${r}`,
                            className: w()(...o, 'has-count'),
                            countLabel: (0,
                            u.sprintf) /* translators: %d is the count of products. */(
                              /* translators: %d is the count of products. */
                              (0, u._n)('%d product', '%d products', c, 'woocommerce'),
                              c,
                            ),
                            'aria-label': (0,
                            u.sprintf) /* translators: %1$s is the attribute name, %2$d is the count of products for that attribute. */(
                        ...
                        selected: o.map(({ id: e }) => p.find(t => t.id === e)).filter(Boolean),
                        type: i,
                      }),
                      !!t &&
                        (0, l.createElement)(
                          ...
                          (0, l.createElement)(m.SelectControl, {
                            ...
                            options: [
                              {
                                label: (0, u.__)('Any selected attributes', 'woocommerce'),
                                value: 'any',
                              },
                              {
                                label: (0, u.__)('All selected attributes', 'woocommerce'),
                                value: 'all',
                              },
                            ],
                          }),
          ...
          K = (0, o.getSetting)('hideOutOfStockItems', !1),
          Y = (0, o.getSetting)('stockStatusOptions', {}),
          q = ({ value: e, setAttributes: t }) => {
            const { outofstock: r, ...n } = Y,
              a = K ? n : Y,
              c = Object.entries(a)
                .map(([e, t]) => ({ value: e, label: t }))
                .filter(e => !!e.label),
              o = Object.keys(a).filter(e => !!e),
              [i, s] = (0, d.useState)(e || o);
            (0, d.useEffect)(() => {
              t({ stockStatus: ['', ...i] });
            }, [i, t]);
            ...
            return (0, l.createElement)(
              ...
              c.map(e => {
                ...
                return (0, l.createElement)(m.ToggleControl, {
                  label: e.label,
                  key: e.value,
            ...
            return (0, l.createElement)(
              ...
              (0, l.createElement)(
                ...
                (0, l.createElement)(E, {
                  ...
                  alignButtons: h,
                  setAttributes: t,
                  minColumns: (0, o.getSetting)('minColumns', 1),
                  maxColumns: (0, o.getSetting)('maxColumns', 6),
                  minRows: (0, o.getSetting)('minRows', 1),
                  maxRows: (0, o.getSetting)('maxRows', 6),
                }),
              ),
              (0, l.createElement)(
                m.PanelBody,
              ...
              (0, l.createElement)(
                m.PanelBody,
                { title: (0, u.__)('Filter by Product Attribute', 'woocommerce'), initialOpen: !1 },
                (0, l.createElement)(G, {
                  selected: r,
                  onChange: (e = []) => {
                    const r = e.map(({ id: e, attr_slug: t }) => ({ id: e, attr_slug: t }));
                    t({ attributes: r });
                  },
                  operator: n,
              ...
              (0, l.createElement)(
                ...
                (0, l.createElement)(z, { setAttributes: t, value: i }),
              ),
              (0, l.createElement)(
                m.PanelBody,
                { title: (0, u.__)('Filter by stock status', 'woocommerce'), initialOpen: !1 },
                (0, l.createElement)(q, { setAttributes: t, value: g }),
              ),
            );
          },
          U = e => {
            ...
            return (0, l.createElement)(
              m.Placeholder,
              {
                ...
                label: (0, u.__)('Products by Attribute', 'woocommerce'),
                className: 'wc-block-products-grid wc-block-products-by-attribute',
              },
              (0, u.__)('Display a grid of products from your selected attributes.', 'woocommerce'),
              (0, l.createElement)(
                'div',
                ...
                (0, l.createElement)(G, {
                  ...
                  onChange: (e = []) => {
                    const t = e.map(({ id: e, value: t }) => ({ id: e, attr_slug: t }));
                    r({ attributes: t });
                  },
                ...
                (0, l.createElement)(
                  m.Button,
                  {
                    ...
                    onClick: () => {
                      c(!o),
                        i((0, u.__)('Showing Products by Attribute block preview.', 'woocommerce'));
                    },
                  },
        ...
        const ee = (0, l.createElement)(
          ...
          te = e => {
            ...
            return t.isPreview ? ee : (0, l.createElement)(Z(), { block: r, attributes: t });
          },
          re = (0, m.withSpokenMessages)(e => {
            const t = (0, s.useBlockProps)(),
              {
                attributes: { attributes: r },
              } = e,
              [n, a] = (0, d.useState)(!r.length);
            return (0, l.createElement)(
              'div',
              { ...t },
              (0, l.createElement)(
                ...
                (0, l.createElement)(m.ToolbarGroup, {
                  controls: [
                    {
                      icon: 'edit',
                      title: (0, u.__)('Edit selected attribute', 'woocommerce'),
                      onClick: () => a(!n),
                      isActive: n,
                    },
                  ],
              ...
              (0, l.createElement)(Q, { ...e }),
              n
                ? (0, l.createElement)(U, { isEditing: n, setIsEditing: a, ...e })
                : (0, l.createElement)(m.Disabled, null, (0, l.createElement)(te, { ...e })),
            );
          });
  ...
  (a.m = l),
    ...
    (a.O = (t, r, l, n) => {
      if (!r) {
        ...
        for (m = 0; m < e.length; m++) {
          for (var [r, l, n] = e[m], o = !0, i = 0; i < r.length; i++)
            (!1 & n || c >= n) && Object.keys(a.O).every(e => a.O[e](r[i]))
              ? r.splice(i--, 1)
              : ((o = !1), n < c && (c = n));
          if (o) {
            e.splice(m--, 1);
    ...
    (a.t = function(e, l) {
      ...
      var c = {};
      t = t || [null, r({}), r([]), r(r)];
      for (var o = 2 & l && e; 'object' == typeof o && !~t.indexOf(o); o = r(o))
    ...
    (() => {
      ...
      var t = (t, r) => {
          ...
          for (t && t(r); s < c.length; s++) (n = c[s]), a.o(e, n) && e[n] && e[n][0](), (e[n] = 0);
          return a.O(m);
        },
  ...
  var c = a.O(void 0, [94], () => a(2518));
  (c = a.O(c)),
    (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['products-by-attribute'] = c);
})();
