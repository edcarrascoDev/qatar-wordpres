(() => {
  var e,
    ...
    o = {
      7379: (e, t, c) => {
        ...
        var w = c(6087);
        const p = window.wp.notices;
        var u = c(5573),
          k = c(9019),
          x = c.n(k);
        const g = (0, i.createElement)(
            ({ className: e, height: t, width: c, ...o }) =>
              (0, i.createElement)(
                u.SVG,
                {
                  xmlns: 'http://www.w3.org/2000/svg',
                  viewBox: '0 0 245 145',
                  className: x()('woo-icon', e),
                  width: c,
                  height: t,
                  ...o,
                },
          ...
          b = ({ blocks: e, findCondition: t }) => {
            for (const c of e) {
              if (t(c)) return c;
              if (c.innerBlocks) {
                const e = b({ blocks: c.innerBlocks, findCondition: t });
                if (e) return e;
              }
            }
          };
        ...
        const f = () =>
            (0, i.createElement)(
              u.SVG,
              { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 892 516' },
              (0, i.createElement)(
                u.G,
                { fill: 'currentColor', transform: 'translate(-1)' },
                (0, i.createElement)(u.Rect, { width: '100', height: '20', x: '1', rx: '2' }),
                (0, i.createElement)(u.Rect, { width: '100', height: '20', x: '421', rx: '2' }),
                (0, i.createElement)(u.Rect, { width: '100', height: '20', x: '793', rx: '2' }),
                (0, i.createElement)(u.Rect, {
                  width: '150',
                  height: '24',
                  x: '125',
                  y: '48',
                ...
                (0, i.createElement)(u.Rect, { width: '520', height: '1', y: '162', rx: '.5' }),
                (0, i.createElement)(u.Rect, {
                  width: '520',
                  height: '1',
                  x: '1',
          ...
          y = () =>
            (0, i.createElement)(
              u.SVG,
              { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 892 726' },
              (0, i.createElement)(
                u.G,
                { fill: 'currentColor', transform: 'translate(-1)' },
                (0, i.createElement)(u.Rect, { width: '203', height: '38', x: '1', rx: '2' }),
                (0, i.createElement)(u.Rect, {
                  width: '434',
                  height: '38',
                  x: '1',
                ...
                (0, i.createElement)(u.Rect, { width: '434', height: '38', y: '124', rx: '2' }),
                (0, i.createElement)(u.Rect, {
                  width: '434',
                  height: '38',
                  x: '1',
                ...
                (0, i.createElement)(u.Rect, { width: '203', height: '38', x: '231', rx: '2' }),
                (0, i.createElement)(u.Rect, { width: '203', height: '38', x: '514', rx: '2' }),
                (0, i.createElement)(u.Rect, {
                  width: '427',
                  height: '100',
                  x: '466',
                ...
                (0, i.createElement)(u.Rect, { width: '38', height: '38', x: '466', rx: '2' }),
                (0, i.createElement)(u.Rect, {
                  width: '203',
                  height: '38',
                  x: '48',
                ...
                (0, i.createElement)(u.Rect, { width: '38', height: '38', y: '662', rx: '2' }),
              ),
            ),
          E = 'cart',
          v = 'checkout',
          _ = {
            cart: {
              type: E,
              title: (0, s.__)('Cart Shortcode', 'woocommerce'),
              description: (0, s.__)('Renders the classic cart shortcode.', 'woocommerce'),
              placeholder: 'cart',
            },
            checkout: {
              type: v,
              title: (0, s.__)('Checkout Cart', 'woocommerce'),
              description: (0, s.__)('Renders the classic checkout shortcode.', 'woocommerce'),
          ...
          R = e =>
            [
              (0, l.createBlock)('woocommerce/checkout', { ...e, className: 'wc-block-checkout' }),
            ].filter(Boolean),
          B = () => (0, s.__)('Classic Checkout', 'woocommerce'),
          O = () =>
            (0, s.__)(
          ...
          P = {
            getButtonLabel: () => (0, s.__)('Transform into blocks', 'woocommerce'),
            onClickCallback: ({
              clientId: e,
              attributes: t,
              getBlocks: c,
            ...
            getBlockifiedTemplate: R,
          },
          I = () => !0,
          S = e =>
            [(0, l.createBlock)('woocommerce/cart', { ...e, className: 'wc-block-cart' })].filter(
              Boolean,
            ),
          T = () => (0, s.__)('Classic Cart', 'woocommerce'),
          j = () =>
            (0, s.__)(
          ...
          z = ({ blockifyConfig: e, clientId: t, attributes: c }) => {
            const { getButtonLabel: o, onClickCallback: r, getBlockifiedTemplate: h } = e,
              [m, u] = (0, w.useState)(!1),
              { replaceBlock: k, selectBlock: x } = (0, d.useDispatch)(n.store),
              { createInfoNotice: g } = (0, d.useDispatch)(p.store),
              { getBlocks: f } = (0, d.useSelect)(e => ({ getBlocks: e(n.store).getBlocks }), []);
            return (0, i.createElement)(
                ...
                a.Button,
                {
                  ...
                  onClick: () => {
                    r({
                      ...
                      g((0, s.__)('Classic shortcode transformed to blocks.', 'woocommerce'), {
                        actions: [
                          {
                            label: (0, s.__)('Undo', 'woocommerce'),
                            onClick: () => {
                              const e = ['woocommerce/cart', 'woocommerce/checkout'],
                                t = b({ blocks: f(), findCondition: t => e.includes(t.name) });
                              t &&
                                k(
                                  t.clientId,
                ...
                m &&
                  (0, i.createElement)(
                    ...
                    (0, i.createElement)(
                      ...
                      (0, i.createElement)(n.BlockPreview, {
                        blocks: h({ ...c, isPreview: !0 }),
                        viewportWidth: 1200,
                        additionalStyles: [
                          {
                            css:
              ...
              (0, i.createElement)(
                ...
                (0, s.__)('Learn more', 'woocommerce'),
              ),
            );
          },
          W = ({ clientId: e, attributes: t }) => {
            var c, o;
            const r = (0, n.useBlockProps)(),
              l = (function(e, t) {
                ...
                for (let r = 0; c.length > r; r++) {
                  const i = t[e.substr(0, c[r].length)];
                  if (i) {
                    o = i;
                    break;
                  }
              ...
              m = t.shortcode,
              d = null !== (c = null == l ? void 0 : l.placeholder) && void 0 !== c ? c : 'cart',
              p = null !== (o = null == l ? void 0 : l.type) && void 0 !== o ? o : 'fallback',
              { isConversionPossible: u, getDescription: k, getTitle: x, blockifyConfig: b } = A[p],
              E = u(),
              v = x ? x() : (0, s.__)('Classic Shortcode Placeholder', 'woocommerce'),
              C = k(m, E),
              R = (0, w.createInterpolateElement)(
                (0, s.__)(
                ...
                {
                  a: (0, i.createElement)(a.ExternalLink, {
                    href: 'https://woocommerce.com/document/cart-checkout-blocks-status/',
                  }),
                },
              );
            return (0, i.createElement)(
              ...
              (0, i.createElement)(
                a.Placeholder,
                { className: 'wp-block-woocommerce-classic-shortcode__placeholder' },
                (0, i.createElement)(
                  'div',
                  { className: 'wp-block-woocommerce-classic-shortcode__placeholder-wireframe' },
                  'cart' === d ? (0, i.createElement)(f, null) : (0, i.createElement)(y, null),
                ),
                (0, i.createElement)(
                  'div',
                  { className: 'wp-block-woocommerce-classic-shortcode__placeholder-copy' },
                  (0, i.createElement)(
                    'div',
                    {
                      className:
                    ...
                    (0, i.createElement)(
                      'span',
                      { className: 'woo-icon' },
                      (0, i.createElement)(h.A, { icon: g }),
                      ' ',
                      (0, s.__)('WooCommerce', 'woocommerce'),
                    ),
                    (0, i.createElement)('span', null, v),
                  ),
                  (0, i.createElement)('p', { dangerouslySetInnerHTML: { __html: C } }),
                  (0, i.createElement)('p', null, R),
                  E &&
                    b &&
                    (0, i.createElement)(z, { clientId: e, blockifyConfig: b, attributes: t }),
                ),
              ),
            );
          },
          D = {
            icon: (0, i.createElement)(h.A, {
              icon: m.A,
              className: 'wc-block-editor-components-block-icon',
            }),
            edit: ({ attributes: e, clientId: t, setAttributes: c }) =>
              (0, i.createElement)(W, { attributes: e, setAttributes: c, clientId: t }),
            save: () => null,
            variations: [
              {
                name: 'checkout',
                title: (0, s.__)('Classic Checkout', 'woocommerce'),
              ...
              {
                name: 'cart',
                title: (0, s.__)('Classic Cart', 'woocommerce'),
  ...
  function i(e) {
    ...
    var c = (r[e] = { exports: {} });
    return o[e].call(c.exports, c, c.exports, i), c.exports;
  }
  (i.m = o),
    (e = []),
    (i.O = (t, c, o, r) => {
      if (!c) {
        ...
        for (h = 0; h < e.length; h++) {
          for (var [c, o, r] = e[h], n = !0, a = 0; a < c.length; a++)
            (!1 & r || l >= r) && Object.keys(i.O).every(e => i.O[e](c[a]))
              ? c.splice(a--, 1)
              : ((n = !1), r < l && (l = r));
          if (n) {
            e.splice(h--, 1);
    ...
    (i.t = function(e, o) {
      ...
      var l = {};
      t = t || [null, c({}), c([]), c(c)];
      for (var n = 2 & o && e; 'object' == typeof n && !~t.indexOf(n); n = c(n))
        Object.getOwnPropertyNames(n).forEach(t => (l[t] = () => e[t]));
      return (l.default = () => e), i.d(r, l), r;
    }),
    (i.d = (e, t) => {
      for (var c in t)
    ...
    (() => {
      ...
      var t = (t, c) => {
          ...
          for (t && t(c); s < l.length; s++) (r = l[s]), i.o(e, r) && e[r] && e[r][0](), (e[r] = 0);
          return i.O(h);
        },
        c = (self.webpackChunkwebpackWcBlocksMainJsonp =
          self.webpackChunkwebpackWcBlocksMainJsonp || []);
      c.forEach(t.bind(null, 0)), (c.push = t.bind(null, c.push.bind(c)));
    })();
  var l = i.O(void 0, [94], () => i(7379));
  (l = i.O(l)),
    (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})['classic-shortcode'] = l);
})();
