(() => {
  ...
  var e,
    ...
    r = {
      86211: (e, t, r) => {
        ...
        function n(e) {
          return e
            ? Array.from(e.querySelectorAll(':scope > input[type=hidden]')).map(e => {
                const t =
                  (r = e) && r.dataset && r.dataset.name
                    ? { term_id: parseInt(r.value, 10), name: r.dataset.name }
                    : null;
                var r;
                return e.remove(), t;
              })
  ...
  (n.m = r),
    ...
    (n.u = e => 'chunks/category-metabox.js?ver=20a83707665172ed4152'),
    (n.miniCssF = e => {}),
    (n.g = (function() {
    ...
    (n.l = (r, o, a, i) => {
      if (e[r]) e[r].push(o);
        ...
        var u = (t, o) => {
          ...
          w = setTimeout(u.bind(null, void 0, { type: 'timeout', target: c }), 12e4);
  ...
  (() => {
    ...
    var e = n(69307),
      t = n(86211);
    const r = (0, e.lazy)(() => n.e(587).then(n.bind(n, 26948))),
      o = document.querySelector('#taxonomy-product_cat-metabox');
    if (o) {
      const n = (0, t.g3)(o.parentElement);
      (0, e.render)(
        (0, e.createElement)(
          e.Suspense,
          { fallback: null },
          (0, e.createElement)(r, { initialSelected: n }),
        ),
        o,
      );
    }
