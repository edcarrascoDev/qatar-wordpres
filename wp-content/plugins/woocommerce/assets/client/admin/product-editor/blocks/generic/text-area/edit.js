...
Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.TextAreaBlockEdit = void 0);
const i18n_1 = require('@wordpress/i18n'),
  ...
  toolbar_button_alignment_1 = __importDefault(require('./toolbar/toolbar-button-alignment')),
...
function TextAreaBlockEdit({ attributes: e, setAttributes: t, context: { postType: o } }) {
  const {
      property: r,
      label: l,
      placeholder: n,
  ...
  if (!r) throw new Error((0, i18n_1.__)('Property attribute is required.', 'woocommerce'));
  const [h, q] = (0, use_product_entity_prop_1.default)(r, { postType: o }),
    { handleBlur: g } = (0, use_clear_selected_block_on_blur_1.useClearSelectedBlockOnBlur)(),
    x = (0, element_1.useRef)(null),
