'use strict';
Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.AttributesBlockEdit = void 0);
...
function AttributesBlockEdit({ attributes: t, context: { isInSelectedTab: e } }) {
  const [r, o] = (0, core_data_1.useEntityProp)('postType', 'product', 'attributes'),
    c = (0, core_data_1.useEntityId)('postType', 'product'),
    _ = (0, block_templates_1.useWooBlockProps)(t),
    { attributes: a, fetchAttributes: i, handleChange: d } = (0,
    use_product_attributes_1.useProductAttributes)({ allAttributes: r, onChange: o, productId: c });
  return (
    ...
    (0, element_1.createElement)(
      ...
      (0, element_1.createElement)(attribute_control_1.AttributeControl, {
        ...
        onRemove: () =>
          (0, tracks_1.recordEvent)('product_remove_attribute_confirmation_confirm_click'),
        onRemoveCancel: () =>
          (0, tracks_1.recordEvent)('product_remove_attribute_confirmation_cancel_click'),
