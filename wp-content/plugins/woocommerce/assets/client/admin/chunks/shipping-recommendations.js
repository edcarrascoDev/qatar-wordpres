  ...
  [6125],
  {
    91462: (e, t, o) => {
      ...
      var i = o(69307),
        ...
        p = o(46530),
        g = o(31815);
      const d = ({ isWCSInstalled: e }) => {
        const { layoutString: t } = (0, p.useLayoutContext)();
        return (0, i.createElement)(
          ...
          (0, i.createElement)(
            ...
            (0, i.createElement)(
              ...
              (0, r.__)('WooCommerce Shipping', 'woocommerce'),
              (0, i.createElement)(a.Pill, null, (0, r.__)('Recommended', 'woocommerce')),
            ),
            (0, i.createElement)(
              'span',
          ...
          (0, i.createElement)(
            ...
            (0, i.createElement)(
              m.Button,
              {
                isSecondary: !0,
                onClick: () => {
                  (0, u.recordEvent)('tasklist_click', {
                    task_name: 'shipping-recommendation',
                    context: `${t}/wc-settings`,
                  }),
                    (0, l.navigateTo)({
                      url: (0, l.getNewPath)({ task: 'shipping-recommendation' }, '/', {}),
                    });
                },
              },
              e ? (0, r.__)('Activate', 'woocommerce') : (0, r.__)('Get started', 'woocommerce'),
            ),
          ),
        );
      };
      var M = o(64760);
      const L = 'woocommerce_admin_reviewed_default_shipping_zones',
        h = 'woocommerce_admin_created_default_shipping_zones',
        S = 'woocommerce-settings-shipping-tour-floater-wrapper',
        N = 'woocommerce-settings-smart-defaults-shipping-tour-floater',
        E = 'table.wc-shipping-zones',
        _ = 'a[href*="woocommerce-services-settings"]',
        j = e => {
          const t = e.map(e => {
              const t = document?.querySelector(e)?.getBoundingClientRect();
              if (!t) throw new Error("Shipping tour: Couldn't find element with selector: " + e);
              return t;
            }),
            o = document.querySelector(`.${S}`)?.getBoundingClientRect() || { top: 0, left: 0 },
            i = Math.min(...t.map(e => e.top)),
            n = Math.min(...t.map(e => e.left)),
            s = Math.max(...t.map(e => e.right)) - n,
            c = Math.max(...t.map(e => e.bottom)) - i,
            r = i - o.top;
          return { left: n - o.left, top: r, width: s, height: c };
        },
        y = ({ dims: e }) =>
        ...
        T = ({ step: e }) => {
          ...
          (0, i.useLayoutEffect)(() => {
            o.current?.parentElement &&
              o.current.parentElement.insertBefore(
                o.current,
                document.querySelector('table.wc-shipping-zones'),
              );
          }, []);
          const n = null !== (t = w[e]) && void 0 !== t ? t : w[w.length - 1],
            [s, c] = (0, i.useState)(j(n));
          (0, i.useEffect)(() => {
            c(j(n));
            ...
            if (!t)
              throw new Error(
                "Shipping tour: Couldn't find shipping settings table element with selector: " + E,
              );
            return (
              e.observe(t),
              () => {
          ...
          const r = document.querySelector(E)?.parentElement;
          if (!r)
            throw new Error(
          ...
          return (0, i.createPortal)(
            (0, i.createElement)(
              'div',
              { ref: o, className: S, style: { position: 'absolute' } },
              (0, i.createElement)(y, { dims: s }),
            ),
            r,
          );
        },
        I = ({ showShippingRecommendationsStep: e }) => {
          const { updateOptions: t } = (0, n.useDispatch)(s.OPTIONS_STORE_NAME),
            { show: o, isUspsDhlEligible: m } = (() => {
              const {
                hasCreatedDefaultShippingZones: e,
                hasReviewedDefaultShippingOptions: t,
                businessCountry: o,
                isLoading: i,
              } = (0, n.useSelect)(e => {
                const { hasFinishedResolution: t, getOption: o } = e(s.OPTIONS_STORE_NAME);
                return {
                  isLoading:
                    !t('getOption', [h]) &&
                    !t('getOption', [L]) &&
                    !t('getOption', ['woocommerce_default_country']),
                  hasCreatedDefaultShippingZones: 'yes' === o(h),
                  hasReviewedDefaultShippingOptions: 'yes' === o(L),
                  businessCountry: (0, c.so)(o('woocommerce_default_country')),
                };
              });
              return {
                isLoading: i,
                show: window.wcAdminFeatures['shipping-setting-tour'] && !i && e && !t,
                isUspsDhlEligible: 'US' === o,
              };
            })(),
            [l, p] = (0, i.useState)(0),
            { createNotice: g } = (0, n.useDispatch)('core/notices'),
            d = {
              placement: 'auto',
              options: {
                effects: {
                ...
                callbacks: {
                  onNextStep: e => {
                    p(e),
                      (0, u.recordEvent)('walkthrough_settings_shipping_next_click', {
                        step_name: d.steps[e - 1].meta.name,
                      });
                  },
                  onPreviousStep: e => {
                    p(e),
                      (0, u.recordEvent)('walkthrough_settings_shipping_back_click', {
                        step_name: d.steps[e + 1].meta.name,
                      });
                  },
                },
              ...
              steps: [
                {
                  referenceElements: { desktop: `.${N}` },
                  meta: {
                    name: 'shipping-zones',
                    heading: (0, r.__)('Shipping zones', 'woocommerce'),
                    descriptions: {
                      desktop: (0, i.createElement)(
                        i.Fragment,
                        null,
                        (0, i.createElement)(
                          'span',
                ...
                },
                {
                  ...
                  meta: {
                    ...
                    heading: (0, r.__)('Shipping methods', 'woocommerce'),
                    descriptions: {
                      desktop: (0, i.createElement)(
                        i.Fragment,
                        null,
              ...
              closeHandler: async (e, o, i) => {
                (await t({ [L]: 'yes' })).success ||
                  (g(
                    'error',
                    (0, r.__)(
                  ...
                  (0, u.recordEvent)('walkthrough_settings_shipping_updated_option_error')),
                  'close-btn' === i
                    ? (0, u.recordEvent)('walkthrough_settings_shipping_dismissed', {
                        step_name: e[o].meta.name,
                      })
                    : 'done-btn' === i &&
                      (0, u.recordEvent)('walkthrough_settings_shipping_completed');
              },
            };
          return (
            document.querySelector(_) &&
              m &&
              d.steps.push({
                referenceElements: { desktop: _ },
                meta: {
                  name: 'woocommerce-shipping',
                  heading: (0, r.__)('WooCommerce Shipping', 'woocommerce'),
                  descriptions: {
                    desktop: (0, r.__)(
            ...
            e &&
              d.steps.push({
                referenceElements: { desktop: 'div.woocommerce-recommended-shipping-extensions' },
                meta: {
            ...
            (0, i.useEffect)(() => {
              o && (0, u.recordEvent)('walkthrough_settings_shipping_view');
            }, [o]),
            o
              ? (0, i.createElement)(
                  'div',
                  null,
                  (0, i.createElement)(T, { step: l }),
                  (0, i.createElement)(a.TourKit, { config: d }),
                )
              : null
          );
        },
        O = () => {
          const {
            ...
            installedPlugins: t,
            countryCode: o,
            isJetpackConnected: r,
            isSellingDigitalProductsOnly: m,
          } = (0, n.useSelect)(e => {
            const t = e(s.SETTINGS_STORE_NAME).getSettings('general'),
              { getActivePlugins: o, getInstalledPlugins: i, isJetpackConnected: n } = e(
                s.PLUGINS_STORE_NAME,
              ),
              r = e(s.ONBOARDING_STORE_NAME).getProfileItems().product_types;
            return {
              activePlugins: o(),
              installedPlugins: i(),
              countryCode: (0, c.so)(t.general?.woocommerce_default_country),
              isJetpackConnected: n(),
              isSellingDigitalProductsOnly: 1 === r?.length && 'downloads' === r[0],
            };
          });
          return (e.includes('woocommerce-services') && r) || 'US' !== o || m
            ? (0, i.createElement)(I, { showShippingRecommendationsStep: !1 })
            : (0, i.createElement)(
                i.Fragment,
                null,
                (0, i.createElement)(I, { showShippingRecommendationsStep: !0 }),
                (0, i.createElement)(
                  M.ShippingRecommendationsList,
                  null,
                  (0, i.createElement)(d, { isWCSInstalled: t.includes('woocommerce-services') }),
                ),
              );
        };
    },
    64760: (e, t, o) => {
      o.r(t), o.d(t, { ShippingRecommendationsList: () => E, default: () => _ });
      var i = o(69307),
        n = o(65736),
        s = o(9818),
        c = o(14812),
      ...
      const d = (0, i.createContext)(''),
        M = ({ children: e, onDismiss: t = () => null }) => {
          const { updateOptions: o } = (0, s.useDispatch)(r.OPTIONS_STORE_NAME),
            c = (0, i.useContext)(d),
            m = () => {
              t(), o({ [c]: 'yes' });
            };
          return (0, i.createElement)(
            a.CardHeader,
            null,
            (0, i.createElement)('div', { className: 'woocommerce-dismissable-list__header' }, e),
            (0, i.createElement)(
              'div',
              null,
              (0, i.createElement)(u.EllipsisMenu, {
                label: (0, n.__)('Task List Options', 'woocommerce'),
                renderContent: () =>
                  (0, i.createElement)(
                    'div',
        ...
        L = ({ children: e, className: t, dismissOptionName: o }) =>
          (0, s.useSelect)(e => {
            const { getOption: t, hasFinishedResolution: i } = e(r.OPTIONS_STORE_NAME),
              n = i('getOption', [o]),
              s = 'yes' === t(o);
            return n && !s;
          })
            ? (0, i.createElement)(
                a.Card,
                { size: 'medium', className: g()('woocommerce-dismissable-list', t) },
                (0, i.createElement)(d.Provider, { value: o }, e),
              )
            : null;
      var h = o(74617),
        S = o(31815);
      const N = ({ onSetupClick: e, pluginsBeingSetup: t }) => {
          const { createSuccessNotice: o } = (0, s.useDispatch)('core/notices'),
            c = (0, s.useSelect)(e => e(r.PLUGINS_STORE_NAME).isJetpackConnected());
          return (0, i.createElement)(
            'div',
            { className: 'woocommerce-list__item-inner woocommerce-services-item' },
            (0, i.createElement)(
            ...
            (0, i.createElement)(
              ...
              (0, i.createElement)(
                'span',
                { className: 'woocommerce-list__item-title' },
                (0, n.__)('WooCommerce Shipping', 'woocommerce'),
                (0, i.createElement)(u.Pill, null, (0, n.__)('Recommended', 'woocommerce')),
              ),
              (0, i.createElement)(
                'span',
                { className: 'woocommerce-list__item-content' },
            ...
            (0, i.createElement)(
              ...
              (0, i.createElement)(
                a.Button,
                {
                  isSecondary: !0,
                  onClick: () => {
                    e(['woocommerce-services']).then(() => {
                      const e = [];
                      c ||
                        e.push({
                          url: (0, h.getAdminLink)('plugins.php'),
                          label: (0, n.__)(
                            'Finish the setup by connecting your store to WordPress.com.',
                            'woocommerce',
                          ),
                        }),
                        o((0, n.__)('🎉 WooCommerce Shipping is installed!', 'woocommerce'), {
                          actions: e,
                        });
                    });
                  },
                  isBusy: t.includes('woocommerce-services'),
                  disabled: t.length > 0,
                },
                (0, n.__)('Get started', 'woocommerce'),
              ),
            ),
          );
        },
          ...
          (0, i.createElement)(
            ...
            (0, i.createElement)(
              ...
              (0, i.createElement)(
                ...
                (0, n.__)('Recommended shipping solutions', 'woocommerce'),
              ),
              (0, i.createElement)(
                c.Text,
                {
            ...
            (0, i.createElement)(
              ...
              i.Children.map(e, e =>
                (0, i.createElement)('li', { className: 'woocommerce-list__item' }, e),
              ),
            ),
            (0, i.createElement)(
              a.CardFooter,
              ...
              (0, i.createElement)(
                a.Button,
                {
                  ...
                  href:
                    'https://woocommerce.com/product-category/woocommerce-extensions/shipping-methods/?utm_source=shipping_recommendations',
                  target: '_blank',
                  isTertiary: !0,
                },
                (0, n.__)('See more options', 'woocommerce'),
                (0, i.createElement)(
                  a.VisuallyHidden,
                  null,
                  (0, n.__)('(opens in a new tab)', 'woocommerce'),
                ),
                (0, i.createElement)(m.Z, { size: 18 }),
              ),
            ),
          ),
        _ = () => {
          const [e, t] = (() => {
            const [e, t] = (0, i.useState)([]),
              { installAndActivatePlugins: o } = (0, s.useDispatch)(r.PLUGINS_STORE_NAME);
            return [
              e,
              i =>
                e.length > 0
                  ...
                  : (t(i),
                    o(i)
                      ...
                      .catch(e => ((0, l.a)(e), t([]), Promise.reject()))),
            ];
          })();
          return (0, s.useSelect)(e => e(r.PLUGINS_STORE_NAME).getActivePlugins()).includes(
            ...
            : (0, i.createElement)(
                E,
                null,
                (0, i.createElement)(N, { pluginsBeingSetup: e, onSetupClick: t }),
              );
        };
    },
    31815: e => {
