  ...
  [5502, 6732],
  {
    86053: (e, t, o) => {
      ...
      class _ extends a.Component {
        render() {
          const { className: e, hasAction: t, hasDate: o, hasSubtitle: c, lines: r } = this.props,
      ...
      (_.propTypes = {
        ...
        (_.defaultProps = { hasAction: !1, hasDate: !1, hasSubtitle: !1, lines: 1 });
      const h = _;
          ...
          return (0, a.createElement)(
            ...
            i &&
              (0, a.createElement)(
                'header',
                { className: 'woocommerce-activity-card__header' },
                (0, a.createElement)(d.H, { className: 'woocommerce-activity-card__title' }, i),
                l &&
                  (0, a.createElement)(
                    'div',
                ...
                _ &&
                  (0, a.createElement)('span', { className: 'woocommerce-activity-card__date' }, _),
              ),
            o &&
      ...
      (w.propTypes = {
        ...
        (w.defaultProps = { icon: (0, a.createElement)(r.Z, { size: 48 }), unread: !1 });
    },
    90353: (e, t, o) => {
      o.d(t, { Z: () => d });
      var a = o(69307),
      ...
      class m extends a.Component {
        render() {
          const { className: e, menu: t, subtitle: o, title: c, unreadMessages: r } = this.props,
            l = n()(
              {
          ...
          return (0, a.createElement)(
            ...
            (0, a.createElement)(
              ...
              (0, a.createElement)(s.Text, { size: 16, weight: 600, color: '#23282d' }, c),
              (0, a.createElement)(
                s.Text,
                { variant: 'button', weight: '600', size: '14', lineHeight: '20px' },
                i > 0 &&
                  (0, a.createElement)('span', { className: 'woocommerce-layout__inbox-badge' }, r),
              ),
            ),
            (0, a.createElement)(
              'div',
    ...
    43631: (e, t, o) => {
      o.r(t),
        o.d(t, { HelpPanel: () => y, SETUP_TASK_HELP_ITEMS_FILTER: () => E, default: () => k });
      var a = o(69307),
        c = o(65736),
        n = o(14812),
        r = o(9818),
      ...
      const y = e => {
        ...
        const o = (function(e) {
          const t = (function(e) {
              ...
              switch (t) {
                case 'products':
                  return [
                    {
                      title: (0, c.__)('Adding and Managing Products', 'woocommerce'),
                      link:
                    ...
                    {
                      title: (0, c.__)('Migrate products using Cart2Cart', 'woocommerce'),
                      link:
                        'https://woocommerce.com/products/cart2cart/?utm_source=help_panel&utm_medium=product',
                    },
                    {
                      title: (0, c.__)('Learn more about setting up products', 'woocommerce'),
                      link:
                ...
                case 'appearance':
                  return [
                    ...
                    {
                      title: (0, c.__)('How to choose and change a theme', 'woocommerce'),
                      link:
                ...
                case 'shipping':
                  return (function({ activePlugins: e, countryCode: t }) {
                    ...
                    return [
                      ...
                      {
                        title: (0, c.__)('Product Shipping Classes', 'woocommerce'),
                        link:
                ...
                case 'tax':
                  return (function(e) {
                    const { countryCode: t, taskLists: o } = e,
                      a = o.reduce((e, t) => [...e, ...t.tasks], []).find(e => 'tax' === e.id);
                    if (!a) return;
                    const { additionalData: n } = a,
                      { woocommerceTaxCountries: r = [], taxJarActivated: l } = n,
                      s = !l && r.includes(t);
                    return [
                      {
                        title: (0, c.__)('Setting up Taxes in WooCommerce', 'woocommerce'),
                        link:
                ...
                case 'payments':
                  return (function(e) {
                    ...
                    return [
                      {
                        title: (0, c.__)('Which Payment Option is Right for Me?', 'woocommerce'),
                        link:
                      ...
                      t.woocommerce_payments && {
                        title: (0, c.__)('WooPayments Start Up Guide', 'woocommerce'),
                        link:
                      ...
                      t.stripe && {
                        title: (0, c.__)('Stripe Setup and Configuration', 'woocommerce'),
                        link:
                          'https://woocommerce.com/document/stripe/?utm_source=help_panel&utm_medium=product',
                      },
                      t['ppcp-gateway'] && {
                        title: (0, c.__)('PayPal Checkout Setup and Configuration', 'woocommerce'),
                        link:
                      ...
                      t.kco && {
                        title: (0, c.__)('Klarna - Introduction', 'woocommerce'),
                        link:
                ...
                case 'marketing':
                  return (function(e) {
                    ...
                    return [
                      t.includes('mailpoet') && {
                        title: (0, c.__)('Get started with Mailpoet', 'woocommerce'),
                        link: 'https://kb.mailpoet.com/category/114-getting-started',
                      },
                      t.includes('google-listings-and-ads') && {
                        title: (0, c.__)('Set up Google Listing & Ads', 'woocommerce'),
                        link:
          ...
          let u = Array.isArray(r) ? r.filter(e => e instanceof Object && e.title && e.link) : [];
          u.length || (u = [o]);
          ...
          return u.map(e => {
            ...
            return {
              ...
              linkType: null !== (t = e.linkType) && void 0 !== t ? t : 'external',
        ...
        return (0, a.createElement)(
          a.Fragment,
          null,
          (0, a.createElement)(w.Z, { title: (0, c.__)('Documentation', 'woocommerce') }),
          (0, a.createElement)(
            u.Section,
            null,
            (0, a.createElement)(u.List, { items: o, className: 'woocommerce-quick-links__list' }),
          ),
        );
      };
    ...
    78855: (e, t, o) => {
      ...
      const d = ({
          ...
          if (!l || !d) return {};
          const u = (l._links && l._links.report[0] && l._links.report[0].href) || '',
            p = (function(e, t, o) {
              return e
                ? '/jetpack' === e
          ...
          return {
            primaryValue: h ? c(l.value) : (0, i.formatValue)(a, l.format, l.value),
            secondaryValue: h ? c(d.value) : (0, i.formatValue)(a, d.format, d.value),
            delta: w,
            reportUrl: p,
            reportUrlType: _,
          };
        ...
        u = (e, t, o, a) => {
          const { getReportItems: n, getReportItemsError: s, isResolving: i } = e(
              l.REPORTS_STORE_NAME,
            ),
            { woocommerce_default_date_range: m } = e(l.SETTINGS_STORE_NAME).getSetting(
              'wc_admin',
              'wcAdminSettings',
            ),
            ...
            w = {
              ...
              before: (0, r.appendTimestamp)(u, u.isSame(c()(), 'day') ? 'now' : 'end'),
              stats: _,
            },
            g = {
              ...h,
              after: (0, r.appendTimestamp)(d.secondary.after, 'start'),
              before: (0, r.appendTimestamp)(p, p.isSame(c()(), 'day') ? 'now' : 'end'),
              stats: _,
            };
          return {
            primaryData: n('performance-indicators', w),
            primaryError: s('performance-indicators', w) || null,
            primaryRequesting: i('getReportItems', ['performance-indicators', w]),
            secondaryData: n('performance-indicators', g),
            secondaryError: s('performance-indicators', g) || null,
            secondaryRequesting: i('getReportItems', ['performance-indicators', g]),
            defaultDateRange: m,
          };
        };
    },
    80136: (e, t, o) => {
      ...
      function C({ unreadOrdersCount: e, orderStatuses: t }) {
        const o = (0, a.useMemo)(
          ...
          { orders: m = [], isRequesting: d, isError: p, customerItems: h } = (0, n.useSelect)(
            a => {
              const { getOrders: c, hasFinishedResolution: n, getOrdersError: l } = a(
                  r.ORDERS_STORE_NAME,
                ),
              ...
              const i = c(o, null),
                m = n('getOrders', [o]);
              if (m || null === e || null === i)
                return { isError: Boolean(l(o)), isRequesting: !0, orderStatuses: t };
              const d = s('customers', {
        ...
        if (p) {
          if (!t.length && window.wcAdminFeatures.analytics)
            return (0, a.createElement)(_.EmptyContent, {
              ...
              actionURL: (0, k.getAdminLink)('admin.php?page=wc-admin&path=/analytics/settings'),
            });
          const e = (0, u.__)(
              ...
              : (function(e, t, o) {
                  if (0 === e.length)
                    return (0, a.createElement)(
                      ...
                      (0, a.createElement)(
                        b.U,
                        { className: 'woocommerce-empty-activity-card', title: '', icon: '' },
                        (0, a.createElement)(
                          'span',
                          {
                        ...
                        (0, a.createElement)(
                          ...
                          (0, u.__)('You’ve fulfilled all your orders', 'woocommerce'),
                        ),
                      ),
                      (0, a.createElement)(
                        _.Link,
                      ...
                      return (
                        s &&
                          ...
                          (i = window.wcAdminFeatures.analytics
                            ...
                            : (0, k.getAdminLink)('user-edit.php?user_id=' + s.id)),
                        (0, a.createElement)(
                          a.Fragment,
                          null,
                          (0, y.Z)({
                            ...
                            components: {
                              orderLink: (0, a.createElement)(_.Link, {
                                href: (0, k.getAdminLink)('post.php?action=edit&post=' + o),
                          ...
                          b.U,
                          {
                            ...
                            subtitle: (0, a.createElement)(
                              ...
                              (0, a.createElement)(
                                ...
                                null,
                                (0, u.sprintf)(
                                  (0, u._n)('%d product', '%d products', s, 'woocommerce'),
                                  s,
                                ),
                              ),
                              (0, a.createElement)('span', null, o(e.total, e.currency)),
                            ),
                          },
      ...
      class A extends a.Component {
        constructor(e) {
          super(e),
            (this.state = { quantity: e.product.stock_quantity, editing: !1, edited: !1 }),
        ...
        async onSubmit() {
          const { product: e, updateProductStock: t, createNotice: o } = this.props,
          ...
          e.stock_quantity !== a
            ? (this.setState({ editing: !1, edited: !0 }),
              (await t(e, a))
                ? o(
                    'success',
                    (0, u.sprintf)((0, u.__)('%s stock updated', 'woocommerce'), e.name),
                    {
                      actions: [
                        {
                          label: (0, u.__)('Undo', 'woocommerce'),
                          onClick: () => {
                            t(e, e.stock_quantity), this.recordStockEvent('undo');
                          },
                        },
                      ],
                    },
        ...
        getBody() {
          ...
          return t
            ? (0, a.createElement)(
                ...
                (0, a.createElement)('span', null, (0, u.__)('in stock', 'woocommerce')),
              )
            : (0, a.createElement)(
                'span',
                {
                  className: i()('woocommerce-stock-activity-card__stock-quantity', {
                    'out-of-stock': e.stock_quantity < 1,
                  }),
                },
                (0, u.sprintf)((0, u.__)('%d in stock', 'woocommerce'), e.stock_quantity),
              );
        }
        render() {
          const { product: e } = this.props,
          ...
          const d = (0, g.get)(e, ['images', 0]) || (0, g.get)(e, ['image']),
            ...
            w = i()('woocommerce-stock-activity-card', { 'is-dimmed': !o && !r }),
            E = (0, a.createElement)(
              b.U,
              { className: w, title: s, subtitle: m, icon: h, date: l, actions: this.getActions() },
              this.getBody(),
            );
          return o
            ? (0, a.createElement)('form', { onReset: this.cancelEdit, onSubmit: this.onSubmit }, E)
            : E;
        }
      }
      const O = {
      ...
      class P extends a.Component {
        ...
        async updateStock(e, t) {
          ...
          return (
            c &&
              (o('getItems', ['products/low-in-stock', O]),
              o('getItemsTotalCount', ['products/count-low-in-stock', E.Ox, null])),
            c
          );
        }
        renderProducts() {
        ...
        render() {
          const { lowStockProductsCount: e, isError: t, isRequesting: o, products: c } = this.props;
          if (t) {
            const e = (0, u.__)(
      ...
      const L = (0, c.compose)(
        (0, n.withSelect)(e => {
          const { getItems: t, getItemsError: o, isResolving: a } = e(r.ITEMS_STORE_NAME);
          return {
            products: Array.from(t('products/low-in-stock', O).values()),
            isError: Boolean(o('products/low-in-stock', O)),
            isRequesting: a('getItems', ['products/low-in-stock', O]),
          };
        }),
        (0, n.withDispatch)(e => {
          const { invalidateResolution: t, updateProductStock: o } = e(r.ITEMS_STORE_NAME),
            { createNotice: a } = e('core/notices');
          return { createNotice: a, invalidateResolution: t, updateProductStock: o };
        }),
      )(P);
      var x = o(28870),
        I = o(41043);
        ...
        (0, a.createElement)(
          ...
          (0, a.createElement)(
            ...
            (0, a.createElement)('path', {
              d:
                'M7.99992 1.33301C4.31992 1.33301 1.33325 4.31967 1.33325 7.99967C1.33325 11.6797 4.31992 14.6663 7.99992 14.6663C11.6799 14.6663 14.6666 11.6797 14.6666 7.99967C14.6666 4.31967 11.6799 1.33301 7.99992 1.33301ZM7.99992 13.333C5.05992 13.333 2.66659 10.9397 2.66659 7.99967C2.66659 5.05967 5.05992 2.66634 7.99992 2.66634C10.9399 2.66634 13.3333 5.05967 13.3333 7.99967C13.3333 10.9397 10.9399 13.333 7.99992 13.333ZM6.66658 9.44634L11.0599 5.05301L11.9999 5.99967L6.66658 11.333L3.99992 8.66634L4.93992 7.72634L6.66658 9.44634Z',
              fill: 'white',
            }),
          ),
          (0, a.createElement)(
            'g',
            { mask: 'url(#mask0)' },
            (0, a.createElement)('rect', { width: '16', height: '16', fill: '#4AB866' }),
          ),
        );
      var H = o(346),
        U = o(37873);
        ...
        deleteReview(e) {
          ...
          e &&
            t(e)
              .then(() => {
                c(),
                  o('success', (0, u.__)('Review successfully deleted.', 'woocommerce'), {
                    actions: [
                      {
                        label: (0, u.__)('Undo', 'woocommerce'),
                        onClick: () => {
                          a(e, { status: 'untrash' }, { _embed: 1 }).then(() => c());
                        },
                      },
                    ],
                  });
              ...
              .catch(() => {
                o('error', (0, u.__)('Review could not be deleted.', 'woocommerce'));
              });
        }
        updateReviewStatus(e, t, o) {
          const { createNotice: a, updateReview: c, clearReviewsCache: n } = this.props;
          e &&
            c(e, { status: t })
              .then(() => {
                n(),
                  a('success', (0, u.__)('Review successfully updated.', 'woocommerce'), {
                    actions: [
                      {
                        label: (0, u.__)('Undo', 'woocommerce'),
                        onClick: () => {
              ...
              .catch(() => {
                a('error', (0, u.__)('Review could not be updated.', 'woocommerce'));
              });
        }
        renderReview(e) {
          const t = (e && e._embedded && e._embedded.up && e._embedded.up[0]) || null;
          if (e.isUpdating)
          ...
          const o = (0, y.Z)({
              ...
              components: {
                ...
                authorLink: (0, a.createElement)(_.Link, {
                  href: (0, k.getAdminLink)(
                    'admin.php?page=wc-admin&path=%2Fcustomers&search=' + e.reviewer,
                  ),
                ...
                verifiedCustomerIcon: e.verified
                  ? (0, a.createElement)(
                      ...
                      (0, a.createElement)(
                        ...
                        (0, a.createElement)('span', null, (0, a.createElement)(F, null)),
                      ),
                    )
                  : null,
              },
            ...
            r = i()('woocommerce-review-activity-card__image-overlay__product', {
            ...
            l = (0, a.createElement)(
              ...
              (0, a.createElement)(
                'div',
                { className: r },
                (0, a.createElement)(_.ProductImage, { product: t, width: 33, height: 33 }),
              ),
            ),
            ...
            m = [
              ...
              (0, a.createElement)(
                h.Button,
                {
                  ...
                  isTertiary: !0,
                  onClick: () => {
                    this.recordReviewEvent('delete', s), this.deleteReview(e.id);
                  },
                },
          ...
          return (0, a.createElement)(
            ...
            (0, a.createElement)('span', { dangerouslySetInnerHTML: (0, H.ZP)(e.review) }),
          );
        }
        renderReviews(e) {
          ...
          return 0 === t.filter(Boolean).length
            ...
            : (0, a.createElement)(
                ...
                (0, a.createElement)(
                  _.Link,
                  {
                    href: (0, k.getAdminLink)('edit.php?post_type=product&page=product-reviews'),
      ...
      (D.propTypes = { reviews: d().array.isRequired, isError: d().bool, isRequesting: d().bool }),
        (D.defaultProps = { reviews: [], isError: !1, isRequesting: !1 }),
        (D.contextType = f.CurrencyContext);
      const B = (0, c.compose)([
        (0, n.withSelect)((e, t) => {
          const { hasUnapprovedReviews: o } = t,
            { getReviews: a, getReviewsError: c, isResolving: n } = e(r.REVIEWS_STORE_NAME);
          let l = [],
            s = !1,
            i = !1;
          return (
        ...
        (0, n.withDispatch)((e, t) => {
          const { deleteReview: o, updateReview: a, invalidateResolution: c } = e(
              r.REVIEWS_STORE_NAME,
            ),
          ...
          return {
            ...
            clearReviewsCache: () => {
              c('getReviews', [q]),
                t.reviews && t.reviews.length < 2 && c('getReviewsTotalCount', [U.wY]);
            },
          };
        }),
      ])(D);
      ...
      const V = { _fields: ['id'] },
        ...
        j = () => {
          const e = (0, n.useSelect)(e => {
              const { getOrdersTotalCount: t, hasFinishedResolution: o } = e(r.ORDERS_STORE_NAME),
                { getProductsTotalCount: a, hasFinishedResolution: c } = e(r.PRODUCTS_STORE_NAME),
                n = t(V, 0),
                l = (0, E.sg)(e),
                ...
                u = (0, U.Vh)(e),
                p = a(Z, 0),
                _ = !o('getOrdersTotalCount', [V, 0]) || !c('getProductsTotalCount', [Z, 0]),
                    ...
                    ? [
                        ...
                        i > 0 &&
                          ...
                          'yes' === c && {
                            ...
                            initialOpen: !1,
                            collapsible: 0 !== e,
                            panel: (0, a.createElement)(L, { lowStockProductsCount: e }),
                        ...
                        l > 0 &&
                          ...
                          'yes' === s && {
                            ...
                            initialOpen: !1,
                            collapsible: 0 !== t,
                            panel: (0, a.createElement)(B, { hasUnapprovedReviews: t > 0 }),
          ...
          if (
            ((0, a.useEffect)(() => {
              if (void 0 !== e.isTaskListHidden) {
                const o = t.reduce((e, t) => ((e[(0, g.snakeCase)(t.id)] = !0), e), {
                    ...
                    h.PanelBody,
                    {
                      title: [
                        (0, a.createElement)(
                          ...
                          { key: s, variant: 'title.small', size: '20', lineHeight: '28px' },
                          s,
                        ),
                        null !== c &&
                          (0, a.createElement)(_.Badge, { key: `${s}-badge`, count: c }),
                      ],
                      key: n,
                      className: t,
                      initialOpen: o(n) || r,
                      ...
                      disabled: !i,
                      onToggle: e => {
                        e && (0, w.recordEvent)('activity_panel_open', { tab: n });
                      },
                    },
                ...
                : (0, a.createElement)(
                    ...
                    (0, a.createElement)(
                      ...
                      (0, a.createElement)(
                        ...
                        null !== c && (0, a.createElement)(_.Badge, { count: c }),
                      ),
                    ),
                  );
            }),
      ...
      const Y = o.p + '0e8ec0e45d8a1d55b30c.png',
        ...
        oe = () => {
          const [e, t] = (0, a.useState)(!0),
            ...
            { isDismissed: c, isResolving: l, isWelcomeModalShown: s } = (0, n.useSelect)(e => {
              const { getOption: t, isResolving: o } = e(r.OPTIONS_STORE_NAME),
                a = t(te);
              return {
                isDismissed: 'yes' === a,
                isWelcomeModalShown: 'yes' !== t(X),
                isResolving: void 0 === a || o('getOption', [te]) || o('getOption', [X]),
              };
            }),
            i = () => {
              o({ [te]: 'yes' }), (0, w.recordEvent)('navigation_intro_modal_close', {}), t(!1);
            };
          if (
            ((0, a.useEffect)(() => {
              l || !s || c || i();
          ...
          const m = (e, t, o) => ({
            content: (0, a.createElement)(
              ...
              (0, a.createElement)(
                ...
                (0, a.createElement)(
                  $.Text,
                  { variant: 'title.large', as: 'h2', size: '32', lineHeight: '40px' },
                  e,
                ),
                (0, a.createElement)(
                  $.Text,
                  { as: 'p', variant: 'body.large', size: '16', lineHeight: '24px' },
                  t,
                ),
              ),
              (0, a.createElement)(
          ...
          return (0, a.createElement)(h.Guide, {
            ...
            pages: [
              m(
                ...
                (0, u.__)('All of your store management features in one place', 'woocommerce'),
                Y,
              ),
              m(
              ...
              m(
                (0, u.__)('Easily find and favorite your extensions', 'woocommerce'),
                (0, u.__)(
      ...
      var ae = o(92694);
      const ce = (0, ae.applyFilters)('woocommerce_admin_homepage_default_stats', [
          'revenue/total_sales',
          'revenue/net_revenue',
          'orders/orders_count',
          'products/items_sold',
      ...
      var re = o(78855);
      const le = (0, n.withSelect)((e, { stats: t, query: o }) => (0, re.A)(e, t, o))(
        ({
          stats: e,
          primaryData: t,
          secondaryData: o,
          ...
          const { formatAmount: d, getCurrencyConfig: p } = (0, a.useContext)(f.CurrencyContext);
          if (r || s) return null;
          ...
          return (0, a.createElement)(
            'ul',
            {
              className: i()('woocommerce-stats-overview__stats', { 'is-even': e.length % 2 == 0 }),
            },
            e.map(e => {
              if (c || n) return (0, a.createElement)(_.SummaryNumberPlaceholder, { key: e.stat });
              const {
                primaryValue: r,
                secondaryValue: l,
                delta: s,
              ...
              return (0, a.createElement)(_.SummaryNumber, {
                ...
                delta: s,
                onLinkClickCallback: () => {
                  (0, w.recordEvent)('statsoverview_indicators_click', { key: e.stat });
                },
              });
            }),
          );
      ...
      const ie = n.controls && n.controls.dispatch ? n.controls.dispatch : se.dispatch;
      n.controls && n.controls.resolveSelect ? n.controls.resolveSelect : se.select;
      const me = e => ie('core/notices', 'createNotice', 'error', e),
        de = ({ onClickInstall: e, onClickDismiss: t, isBusy: o, jetpackInstallState: c }) =>
          (0, a.createElement)(
            'article',
            ...
            (0, a.createElement)(
              ...
              (0, a.createElement)(
                h.Button,
                {
                  isTertiary: !0,
                  onClick: () => {
                    (0, w.recordEvent)('statsoverview_dismiss_install_jetpack'), t();
                  },
                  disabled: o,
                  isBusy: o,
                },
        ...
        ue = () => {
          const { currentUserCan: e } = (0, r.useUser)(),
            ...
            { canUserInstallPlugins: c, jetpackInstallState: l, isBusy: s } = (0, n.useSelect)(
              t => {
                const { getPluginInstallState: o, isPluginsRequesting: a } = t(
                  ...
                  c = o('jetpack');
                return {
                  isBusy: a('getJetpackConnectUrl') || a('installPlugins') || a('activatePlugins'),
                  jetpackInstallState: c,
                  canUserInstallPlugins: e('install_plugins'),
                };
              },
            ),
            { installJetpackAndConnect: i } = (0, n.useDispatch)(r.PLUGINS_STORE_NAME);
          return c
        ...
        we = () => {
          const { updateUserPreferences: e, ...t } = (0, r.useUserPreferences)(),
            o = (0, g.get)(t, ['homepage_stats', 'hiddenStats'], ne),
            c = (0, n.useSelect)(e => e(r.PLUGINS_STORE_NAME).isJetpackConnected(), []),
            s = (t.homepage_stats || {}).installJetpackDismissed,
            i = _e.filter(e => !o.includes(e.stat));
          return (0, a.createElement)(
            h.Card,
            { size: 'large', className: 'woocommerce-stats-overview woocommerce-homescreen-card' },
            (0, a.createElement)(
              h.CardHeader,
              { size: 'medium' },
              (0, a.createElement)(he, null),
              (0, a.createElement)(_.EllipsisMenu, {
                label: (0, u.__)('Choose which values to display', 'woocommerce'),
                renderContent: () =>
                  (0, a.createElement)(
                    a.Fragment,
                    null,
                          ...
                          onInvoke: () =>
                            (t => {
                              ...
                              e({ homepage_stats: { hiddenStats: a } }),
                                (0, w.recordEvent)('statsoverview_indicators_toggle', {
                                  indicator_name: t,
            ...
            (0, a.createElement)(
              h.TabPanel,
              {
                ...
                onSelect: e => {
                  (0, w.recordEvent)('statsoverview_date_picker_update', { period: e });
                },
                tabs: [
                  { title: (0, u.__)('Today', 'woocommerce'), name: 'today' },
                  { title: (0, u.__)('Week to date', 'woocommerce'), name: 'week' },
                  { title: (0, u.__)('Month to date', 'woocommerce'), name: 'month' },
                ],
              },
              e =>
                (0, a.createElement)(
      ...
      const Se = ({ title: e, children: t }) =>
        (0, a.createElement)(
          ...
          (0, a.createElement)('h3', { className: 'woocommerce-quick-links__category-header' }, e),
          t,
        );
      var Ce = o(23374),
        Me = o(12532);
      ...
      function ze({ path: e, tab: t = null, type: o, href: a = null }) {
        return (
          {
            'wc-admin': { href: `admin.php?page=wc-admin&path=%2F${e}`, linkType: 'wc-admin' },
            'wp-admin': { href: e, linkType: 'wp-admin' },
            'wc-settings': { href: `admin.php?page=wc-settings&tab=${t}`, linkType: 'wp-admin' },
          }[o] || { href: a, linkType: 'external' }
        );
      }
      const Re = () => {
        const e = (0, N.O3)('shopUrl'),
          t = (0, ae.applyFilters)('woocommerce_admin_homescreen_quicklinks', []).reduce(
            (e, { icon: t, href: o, title: a }) => (
              new URL(o, window.location.href).origin === window.location.origin &&
                e.push({
                  icon: t,
            ...
            return [
              {
                ...
                items: [
                  ...
                  },
                  {
                    ...
                    link: ze({ type: 'wp-admin', path: 'post-new.php?post_type=product' }),
                    icon: Ee.Z,
        ...
        return (0, a.createElement)(
          ...
          (0, a.createElement)(
            h.CardBody,
            { size: 'custom', className: 'woocommerce-store-management-links__card-body' },
            n.map(e =>
              (0, a.createElement)(
                Se,
                { key: e.title, title: e.title },
                e.items.map(
                  ({ icon: e, listItemTag: t, title: o, link: { href: c, linkType: n } }) =>
                    (0, a.createElement)(Te, {
                      ...
                      href: c,
                      onClick: () => {
                        (0, w.recordEvent)('home_quick_links_click', { task_name: t });
                      },
                    }),
                ),
              ),
      ...
      const Oe = () =>
          (0, a.createElement)(
            ...
            (0, a.createElement)(
              ...
              (0, a.createElement)('path', {
                ...
                fillOpacity: '.65',
                d:
                  'M364.607 150.419H357v25.307h7.607v-25.307zM379.317 132h-7.607v43.455h7.607V132zM394.026 136h-7.607v61.603h7.607V136zM408.736 123h-7.607v55.726h7.607V123zM423.445 132.197h-7.607v38.342h7.607v-38.342z',
                opacity: '.2',
              }),
              (0, a.createElement)('path', {
                fill: '#fff',
                d:
                  'M356.331 134l-.331-.495 15.486-21.052 13.65 14.005 11.039-17.456 4.84 5.868 13.168-11.268 14.625 14.021L451.763 99l.237.594-23.213 18.833-14.619-14.015-13.201 11.297-4.748-5.756-11.014 17.418-13.677-14.031L356.331 134z',
              }),
            ),
            (0, a.createElement)(
              'defs',
              ...
              (0, a.createElement)(
                'clipPath',
                { id: 'clip0' },
                (0, a.createElement)('path', { fill: '#fff', d: 'M0 0h517v160H0z' }),
              ),
            ),
          ),
        Pe = ({ title: e, body: t }) =>
        ...
        Le = {
          image: (0, a.createElement)(Oe, null),
          content: (0, a.createElement)(Pe, {
            title: (0, u.__)('Welcome to your new store management experience', 'woocommerce'),
            body: (0, y.Z)({
              mixedString: (0, u.__)(
      ...
      function xe({ onClose: e }) {
        ...
        if (
          ...
          return null;
        const c = i()('woocommerce__welcome-modal', 'woocommerce__welcome-from-calypso-modal');
        return (0, a.createElement)(h.Guide, {
          onFinish: () => {
            e && e(), o(!1), (0, w.recordEvent)('welcome_from_calypso_modal_close');
          },
          className: c,
      ...
      const Ie = [
          {
            image: (0, a.createElement)(Oe, null),
            content: (0, a.createElement)(Pe, {
              title: (0, u.__)('Welcome to your WooCommerce store’s online HQ!', 'woocommerce'),
              body: (0, u.__)(
          ...
          },
          {
                ...
                (0, a.createElement)(
                  ...
                  (0, a.createElement)(
                    ...
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M154.016 67.733h-13.493V54.274h13.493v13.46zm-12.819-.673h12.144V54.947h-12.144V67.06z',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                    ...
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M248.466 147.142h-114.69v-25.909h114.69v25.909zm-114.015-.673h113.341v-24.563H134.451v24.563z',
                    }),
                    (0, a.createElement)('path', {
                      fill: '#CCC',
                    ...
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M154.016 141.085h-13.493v-13.459h13.493v13.459zm-12.819-.673h12.144v-12.113h-12.144v12.113z',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                    ...
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M289.62 110.465H174.93V84.557h114.69v25.908zm-114.016-.672h113.341V85.23H175.604v24.563z',
                    }),
                    (0, a.createElement)('path', {
                      fill: '#CCC',
                    ...
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M282.873 104.409H269.38V90.95h13.493v13.459zm-12.818-.673h12.144V91.623h-12.144v12.113z',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                    ...
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M266.035 66.154a5.363 5.363 0 005.369-5.356 5.363 5.363 0 00-5.369-5.356c-2.966 0-5.37 2.398-5.37 5.356 0 2.958 2.404 5.356 5.37 5.356zM273.793 140.515c2.966 0 5.37-2.398 5.37-5.356 0-2.958-2.404-5.356-5.37-5.356a5.363 5.363 0 00-5.369 5.356 5.363 5.363 0 005.369 5.356zM153.706 102.83a5.363 5.363 0 005.37-5.356c0-2.959-2.404-5.357-5.37-5.357s-5.37 2.398-5.37 5.357a5.363 5.363 0 005.37 5.356z',
                      opacity: '.5',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M401.276 172h-70.552a8.79 8.79 0 01-6.169-2.517 8.532 8.532 0 01-2.555-6.078V131.56a3.368 3.368 0 011.078-2.471l37.386-34.915A8.113 8.113 0 01366 92c2.06 0 4.041.778 5.536 2.174l35.645 33.289a8.882 8.882 0 012.084 2.944 8.78 8.78 0 01.735 3.515v29.483c0 2.28-.919 4.466-2.555 6.078a8.79 8.79 0 01-6.169 2.517z',
                    }),
                    (0, a.createElement)('path', {
                      fill: '#F0F0F0',
                      d:
                        'M393.267 106h-54.534c-2.614 0-4.733 2.053-4.733 4.585v52.83c0 2.532 2.119 4.585 4.733 4.585h54.534c2.614 0 4.733-2.053 4.733-4.585v-52.83c0-2.532-2.119-4.585-4.733-4.585z',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M366 150.493l-41.579-20.323a1.667 1.667 0 00-1.631.091 1.695 1.695 0 00-.579.619 1.725 1.725 0 00-.211.826v34.967a5.345 5.345 0 001.543 3.767 5.261 5.261 0 003.725 1.56h77.464a5.261 5.261 0 003.725-1.56 5.345 5.345 0 001.543-3.767v-34.368c0-.352-.088-.699-.257-1.008a2.069 2.069 0 00-1.688-1.071 2.035 2.035 0 00-1.009.205L366 150.493zM390 118h-48v2h48v-2zM390 124h-48v2h48v-2z',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                    ...
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M336 98a8.003 8.003 0 00-7.391 4.939 7.992 7.992 0 00-.455 4.622 7.993 7.993 0 006.285 6.285A8 8 0 00344 106a8.022 8.022 0 00-8-8zm-1.642 12.265l-4.1-4.1 1.15-1.15 2.954 2.954 6.234-6.234 1.15 1.15-7.388 7.38z',
                    }),
                  ),
                  (0, a.createElement)(
                    'defs',
            ...
            content: (0, a.createElement)(Pe, {
              title: (0, u.__)('A personalized inbox full of relevant advice', 'woocommerce'),
              body: (0, u.__)(
          ...
          },
          {
              ...
              () =>
                (0, a.createElement)(
                  ...
                  (0, a.createElement)(
                    ...
                    (0, a.createElement)('path', { fill: '#F6F7F7', d: 'M124 33h267v185H124z' }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M169 152.005V229a734.947 734.947 0 01-15.628-.991l-2.372-.181v-75.823c0-.395.072-.785.212-1.15.14-.365.345-.696.604-.975.258-.279.565-.5.903-.651a2.61 2.61 0 011.066-.229h12.43c.366 0 .728.078 1.066.229.338.151.645.372.903.651.259.279.464.61.604.975.14.365.212.755.212 1.15z',
                      opacity: '.7',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M186 229.733V127.377c0-.63.31-1.235.861-1.681.551-.446 1.299-.696 2.079-.696h13.12c.386 0 .768.061 1.125.181.357.119.681.294.954.515.273.221.489.483.637.771.148.289.224.598.224.91V230l-19-.267z',
                      opacity: '.5',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M225 230.002v-97.406a2.843 2.843 0 012.843-2.845h12.689a2.844 2.844 0 012.844 2.845v97.196l-18.376.21z',
                      opacity: '.7',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M282 88.368v140.224c-6 .145-12 .281-18 .408V88.368c0-.628.293-1.23.816-1.674.522-.445 1.231-.694 1.969-.694h12.43c.738 0 1.447.25 1.969.694.523.444.816 1.046.816 1.674z',
                      opacity: '.5',
                    }),
                    (0, a.createElement)('path', {
                      className: 'fill-theme-color',
                      d:
                        'M319 112.954v115.709c-6 .12-12 .232-18 .337V112.954c0-.518.293-1.015.816-1.382.522-.366 1.231-.572 1.969-.572h12.43c.738 0 1.447.206 1.969.572.523.367.816.864.816 1.382z',
                      opacity: '.7',
                    }),
                    (0, a.createElement)('path', {
                      stroke: '#CCC',
            ...
            content: (0, a.createElement)(Pe, {
              title: (0, u.__)('Good data leads to smart business decisions', 'woocommerce'),
              body: (0, u.__)(
            ...
            (0, a.createElement)(
              ...
              t &&
                (0, a.createElement)(h.Guide, {
                  onFinish: () => {
                    o(!1), e(), (0, w.recordEvent)('task_list_welcome_modal_close');
                  },
      ...
      const qe = o.p + '93973815f7cd64d5f512.png',
        De = ({ body: e }) =>
          (0, a.createElement)(
            ...
            (0, a.createElement)('div', { className: 'mobile-app-modal-content' }, e),
            (0, a.createElement)(
              'div',
              { className: 'mobile-app-modal-illustration' },
              (0, a.createElement)('img', {
                src: qe,
                alt: (0, u.__)('Screen captures of the WooCommerce mobile app', 'woocommerce'),
              }),
            ),
          ),
        ...
        je = () => {
          const { currentUserCan: e } = (0, r.useUser)(),
            { canUserInstallPlugins: t, jetpackInstallState: o, jetpackConnectionData: c } = (0,
            n.useSelect)(t => {
              const { getPluginInstallState: o, getJetpackConnectionData: a } = t(
                  r.PLUGINS_STORE_NAME,
                ),
                c = o('jetpack');
              return {
            ...
            { installJetpackAndConnect: l } = (0, n.useDispatch)(r.PLUGINS_STORE_NAME),
            [s, i] = (0, a.useState)(Ze),
            m = (0, a.useCallback)(() => {
                ...
                switch (o) {
                  ...
                  case 'activated':
                    c && !c?.connectionOwner
                      ...
                      ? i(We)
                      : c && c?.currentUser?.isConnected && c?.currentUser?.isMaster && i(Ve);
                }
              else i(Be);
            }, [t, o, c]),
      ...
      const $e = 'fetching',
        ...
        Ke = ({ onClickHandler: e, isFetching: t }) =>
          (0, a.createElement)(
            ...
            t && (0, a.createElement)(_.Spinner, { className: 'send-magic-link-spinner' }),
            (0, a.createElement)(
              'div',
              {
        ...
        Xe = ({ returnToSendLinkPage: e }) =>
          (0, a.createElement)(
            ...
            (0, a.createElement)('div', { className: 'email-sent-illustration' }),
            (0, a.createElement)(
              'div',
              { className: 'email-sent-title' },
              (0, a.createElement)('h1', null, (0, u.__)('Check your email!', 'woocommerce')),
            ),
            (0, a.createElement)(
              'div',
      ...
      const ot = () =>
          (0, a.createElement)(
            ...
            (0, a.createElement)(tt.tv, {
              value: 'https://woocommerce.com/mobile/?utm_source=wc_onboarding_mobile_task',
              size: 140,
            }),
          ),
        at = ({ loginUrl: e }) =>
        ...
        ct = ({
          ...
          return (
                ...
                if (t && void 0 !== o)
                  ...
                  const e = (0, N.O3)('siteUrl'),
                    ...
                    c = o
                      ...
                      : (0, u.__)('Follow the instructions in the app to sign in.', 'woocommerce');
                  s([
                    {
                      key: 'first',
                      label: (0, u.__)('App installed', 'woocommerce'),
            ...
            (0, a.createElement)(
              ...
              l && (0, a.createElement)(_.Stepper, { isVertical: !0, currentStep: e, steps: l }),
            )
          );
        },
        nt = ({
          ...
          (0, a.createElement)(
            ...
            (0, a.createElement)(
              ...
              (0, a.createElement)(
                'h3',
                null,
                (0, u.__)('Run your store from anywhere in two easy steps.', 'woocommerce'),
              ),
            ),
      ...
      const lt = () => {
          const [e, t] = (0, a.useState)(!1),
            [o, c] = (0, a.useState)(!1),
            { state: s, jetpackConnectionData: i } = je(),
            { updateOptions: m } = (0, n.useDispatch)(r.OPTIONS_STORE_NAME),
            [d, p] = (0, a.useState)(),
            [_] = (0, He.lr)();
          (0, a.useEffect)(() => {
            _.get('mobileAppModal') ? t(!0) : t(!1), 'returning' === _.get('jetpackState') && c(!0);
          }, [_]);
            ...
            { requestState: b, fetchMagicLinkApiCall: N } = (() => {
              ...
              return {
                ...
                fetchMagicLinkApiCall: (0, a.useCallback)(() => {
                  t($e),
                    Je()({ path: `${r.WC_ADMIN_NAMESPACE}/mobile-app/send-magic-link` })
                      .then(e => {
                        'success' === e.code
                          ? t(Ye)
                          : (t(Qe),
                            o(
                              'error',
                              (0, u.__)('Sorry, an unknown error occurred.', 'woocommerce'),
                            ));
                      })
                      .catch(e => {
                        t(Qe),
                          (0, w.recordEvent)('magic_prompt_send_magic_link_error', {
                            error: e.message,
                            code: e.code,
                          }),
                          'error_sending_mobile_magic_link' === e.code
                            ...
                            ? o('error', e.message)
                            : o('error', "We couldn't send the link. Try again in a few seconds.");
                      });
                }, [o]),
              };
            })(),
          ...
          return (
            ...
            (0, a.useEffect)(() => {
              if (v)
                p(
                  (0, a.createElement)(Xe, {
                    returnToSendLinkPage: () => {
                      y(!1), f(!0), (0, w.recordEvent)('magic_prompt_retry_send_signin_link');
                    },
                  }),
                );
              else {
                var e;
                const t =
                    null !== (e = s === Ve && void 0 !== i?.currentUser?.wpcomUser?.email) &&
                    void 0 !== e &&
                    e,
              ...
              t =>
                e === Ze || e === Be || e === We
                  ...
                  : [
                      ...t,
                      {
                        title: (0, u.__)('Get the WooCommerce app', 'woocommerce'),
                        link: (0, k.getAdminLink)('./admin.php?page=wc-admin&mobileAppModal=true'),
                        linkType: 'wc-admin',
                      },
                    ],
              [e],
      ...
      const it = 'woocommerce_homescreen_experimental_header_banner_item',
        mt = ({ children: e, order: t = 1 }) =>
          (0, a.createElement)(h.Fill, { name: it }, o => (0, _.createOrderedChildren)(e, t, o));
      mt.Slot = ({ fillProps: e }) =>
        (0, a.createElement)(h.Slot, { name: it, fillProps: e }, _.sortFillsByOrder);
      const dt = ({ className: e }) => {
        ...
        pt = ({ children: e, order: t = 1 }) =>
          (0, a.createElement)(h.Fill, { name: ut }, o => (0, _.createOrderedChildren)(e, t, o));
      pt.Slot = ({ fillProps: e }) =>
        (0, a.createElement)(h.Slot, { name: ut, fillProps: e }, _.sortFillsByOrder);
      const _t = ({ className: e }) => {
        ...
        wt = ({
          ...
          const w = (0, r.useUserPreferences)(),
            ...
            y = Object.keys(t).length > 0 && !t.task,
          ...
          const S = b.current && f,
            ...
            M = () =>
              (0, a.createElement)(
                a.Suspense,
                { fallback: (0, a.createElement)(Ae.TasksPlaceholder, { query: t }) },
                k &&
                  y &&
                  (0, a.createElement)(
                    a.Fragment,
          ...
          return (0, a.createElement)(
            ...
            y &&
              (0, a.createElement)(dt, {
                className: i()('woocommerce-homescreen', { 'woocommerce-homescreen-column': !f }),
              }),
            (0, a.createElement)(
              'div',
              ...
              y
                ? (0, a.createElement)(
                    ...
                    (0, a.createElement)(
                      G,
                      { shouldStick: S },
                      window.wcAdminFeatures.analytics && (0, a.createElement)(we, null),
              ...
              window.wcAdminFeatures.navigation && (0, a.createElement)(oe, null),
            ),
          );
        };
      wt.propTypes = {
      ...
      const gt = (0, c.compose)(
          (0, n.withSelect)(e => {
            const { isNotesRequesting: t } = e(r.NOTES_STORE_NAME),
              { getOption: o, hasFinishedResolution: a } = e(r.OPTIONS_STORE_NAME),
              { getTaskList: c, getTaskLists: n, hasFinishedResolution: l } = e(
            ...
            return {
              defaultHomescreenLayout: o('woocommerce_default_homepage_layout') || 'single_column',
              ...
              showingProgressHeader: !!s.find(e => e.isVisible && e.displayProgressHeader),
              taskListComplete: c('setup')?.isComplete,
            };
          }),
          (0, n.withDispatch)(e => ({ updateOptions: e(r.OPTIONS_STORE_NAME).updateOptions })),
        )(wt),
        Et = (0, N.O3)('onboarding', {}),
        vt = (0, c.compose)(
          (0, r.withOnboardingHydration)({ profileItems: Et.profile }),
          (0, n.withSelect)(e => {
            const { getProfileItems: t, hasFinishedResolution: o } = e(r.ONBOARDING_STORE_NAME);
            return { profileItems: t(), hasFinishedResolution: o('getProfileItems', []) };
          }),
        )(({ profileItems: { completed: e, skipped: t } = {}, hasFinishedResolution: o }) => {
          (0, a.useEffect)(() => {
            !o || e || t || (0, l.getHistory)().push((0, l.getNewPath)({}, '/setup-wizard', {}));
          }, [o, e, t]);
    ...
    63724: (e, t, o) => {
      ...
      const E = ({ onClose: e }) => {
          const { createNotice: t } = (0, s.useDispatch)('core/notices'),
            { batchUpdateNotes: o, removeAllNotes: n } = (0, s.useDispatch)(l.NOTES_STORE_NAME);
          return (0, a.createElement)(
            a.Fragment,
            null,
            (0, a.createElement)(
                ...
                (0, a.createElement)(
                  ...
                  (0, a.createElement)(
                    r.Button,
                    {
                      ...
                      onClick: () => {
                        (async () => {
                          (0, i.recordEvent)('wcadmin_inbox_action_dismissall', {});
                          try {
                            const e = await n({ status: 'unactioned' });
                            t('success', (0, c.__)('All messages dismissed', 'woocommerce'), {
                              actions: [
                                {
                            ...
                            t('error', (0, c.__)('Messages could not be dismissed', 'woocommerce')),
                              e();
                          }
                        })(),
                          e();
                ...
                (0, a.createElement)(
                  ...
                  Boolean(S.length) &&
                    (({
                      ...
                      b || ((0, i.recordEvent)('inbox_panel_view', { total: o.length }), (b = !0));
                        ...
                        w &&
                          (0, a.createElement)(
                            ...
                            (0, a.createElement)(n.EllipsisMenu, {
                              label: (0, c.__)('Inbox Notes Options', 'woocommerce'),
                      ...
                      loadMoreNotes: () => {
                        (0, i.recordEvent)('inbox_action_load_more', { quantity_shown: S.length }),
                          o(t + 10);
                      },
                      hasNotes: (0, w.kS)(S),
                      isBatchUpdating: U,
                      ...
                      onDismiss: async e => {
                        ...
                        try {
                          await R(t),
                            P('getNotes'),
                            z('success', (0, c.__)('Message dismissed', 'woocommerce'), {
                              actions: [
                                {
                                  label: (0, c.__)('Undo', 'woocommerce'),
                                  onClick: async () => {
                                    await A(t, { is_deleted: 0 }), P('getNotes');
                                  },
                                },
                              ],
                            });
