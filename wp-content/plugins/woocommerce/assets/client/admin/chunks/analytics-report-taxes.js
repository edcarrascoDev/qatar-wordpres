...
(globalThis.webpackChunk_wcAdmin_webpackJsonp =
  ...
  [9792],
  {
    47478: (e, t, r) => {
      ...
      class f extends a.Component {
        ...
        getTimeChartData() {
          const {
            ...
            { primary: i, secondary: l } = (0, p.getCurrentDates)(e, o);
          return t.data.intervals.map(function(t, o) {
            const c = (0, p.getPreviousDate)(t.date_start, i.after, l.after, e.compare, s),
        ...
        renderChart(e, t, r, s) {
          const {
            ...
            C = (0, p.getIntervalForQuery)(g, x),
            v = (0, p.getAllowedIntervalsForQuery)(g, x),
            R = (0, p.getDateFormatsForInterval)(C, f.data.intervals.length, { type: 'php' }),
            q = n
              ? (0, o.__)('No data for the current search', 'woocommerce')
              : (0, o.__)('No data for the selected date range', 'woocommerce'),
            { formatAmount: w, getCurrencyConfig: S } = this.context;
          return (0, a.createElement)(d.Chart, {
            ...
            path: y,
            query: g,
            screenReaderFormat: b(R.screenReaderFormat),
            showHeaderControls: _,
            title: h.label,
            tooltipLabelFormat: b(R.tooltipLabelFormat),
            tooltipTitle: ('time-comparison' === e && h.label) || null,
            tooltipValueFormat: (0, u.getTooltipValueFormat)(h.type, w),
            chartType: (0, p.getChartTypeForQuery)(g),
            valueType: h.type,
            xFormat: b(R.xFormat),
            x2Format: b(R.x2Format),
            currency: S(),
          });
        }
      ...
      (f.contextType = y.CurrencyContext),
        (f.propTypes = {
          filters: m().array,
          isRequesting: m().bool,
          itemsLabel: m().string,
        ...
        (0, i.withSelect)((e, t) => {
          const {
            ...
            y =
              ...
              'time-comparison',
            { woocommerce_default_date_range: g } = e(u.SETTINGS_STORE_NAME).getSetting(
              'wc_admin',
              'wcAdminSettings',
            ),
          ...
          if (i.search && !f) return { ...b, emptySearchResults: !0 };
          const x = r && r.map(e => e.key),
            C = (0, u.getReportChartData)({
              endpoint: a,
              dataType: 'primary',
              query: i,
              selector: h,
          ...
          if ('item-comparison' === y) return { ...b, primaryData: C };
          const v = (0, u.getReportChartData)({
            endpoint: a,
            dataType: 'secondary',
            query: i,
            selector: h,
          ...
          return { ...b, primaryData: C, secondaryData: v };
        }),
      )(f);
    },
    80272: (e, t, r) => {
          ...
          return (0, a.createElement)(m.SummaryList, null, ({ onToggle: t }) =>
            e.map(e => {
              const {
                ...
                b = { chart: s };
              d && (b.orderby = d), l && (b.order = l);
              const f = (0, c.getNewPath)(b),
                x = r.key === s,
                { delta: C, prevValue: v, value: R } = this.getValues(s, p);
    ...
    56703: (e, t, r) => {
      ...
      const { addCesSurveyForAnalytics: m } = (0, i.dispatch)(s.STORE_KEY),
        ...
        u = (0, o.applyFilters)('woocommerce_admin_taxes_report_advanced_filters', {
          filters: {},
          title: (0, a._x)(
        ...
        p = [
          { label: (0, a.__)('All taxes', 'woocommerce'), value: 'all' },
          {
            ...
            settings: {
              type: 'taxes',
              param: 'taxes',
              getLabels: (0, l.qc)(n.NAMESPACE + '/taxes', e => ({
                id: e.id,
                key: e.id,
                label: (0, c.I)(e),
              })),
              labels: {
                helpText: (0, a.__)('Check at least two tax codes below to compare', 'woocommerce'),
      ...
      Object.keys(u.filters).length &&
        p.push({ label: (0, a.__)('Advanced filters', 'woocommerce'), value: 'advanced' });
    ...
    82210: (e, t, r) => {
      ...
      class b extends a.Component {
        ...
        getHeadersContent() {
          return [
            {
              label: (0, n.__)('Tax code', 'woocommerce'),
              key: 'tax_code',
              required: !0,
              isLeftAligned: !0,
              isSortable: !0,
            },
            { label: (0, n.__)('Rate', 'woocommerce'), key: 'rate', isSortable: !0, isNumeric: !0 },
            { label: (0, n.__)('Total tax', 'woocommerce'), key: 'total_tax', isSortable: !0 },
            { label: (0, n.__)('Order tax', 'woocommerce'), key: 'order_tax', isSortable: !0 },
            {
              label: (0, n.__)('Shipping tax', 'woocommerce'),
              key: 'shipping_tax',
              isSortable: !0,
            },
            {
        ...
        getRowsContent(e) {
          const { render: t, formatDecimal: r, getCurrencyConfig: o } = this.context;
          return (0, d.map)(e, e => {
            const { query: s } = this.props,
              {
                order_tax: n,
                orders_count: i,
                tax_rate: l,
              ...
              g = (0, h.I)(e),
              _ = (0, p.getPersistedQuery)(s),
              b = (0, p.getNewPath)(_, '/analytics/orders', {
                filter: 'advanced',
                tax_rate_includes: c,
              });
            return [
              { display: (0, a.createElement)(u.Link, { href: b, type: 'wc-admin' }, g), value: g },
              { display: l.toFixed(2) + '%', value: l },
              { display: t(m), value: r(m) },
              { display: t(n), value: r(n) },
              { display: t(d), value: r(d) },
              { display: (0, y.formatValue)(o(), 'number', i), value: i },
            ];
          });
        }
        getSummary(e) {
          const {
            ...
            { formatAmount: i, getCurrencyConfig: l } = this.context,
            c = l();
          return [
            {
              label: (0, n._n)('tax code', 'tax codes', t, 'woocommerce'),
              value: (0, y.formatValue)(c, 'number', t),
            },
            { label: (0, n.__)('total tax', 'woocommerce'), value: i(r) },
            { label: (0, n.__)('order tax', 'woocommerce'), value: i(a) },
            { label: (0, n.__)('shipping tax', 'woocommerce'), value: i(o) },
            {
              label: (0, n._n)('order', 'orders', s, 'woocommerce'),
              value: (0, y.formatValue)(c, 'number', s),
            },
          ];
        }
        render() {
          const { advancedFilters: e, filters: t, isRequesting: r, query: o } = this.props;
          return (0, a.createElement)(_.Z, {
            ...
            query: o,
            searchBy: 'taxes',
            tableQuery: { orderby: o.orderby || 'tax_rate_id' },
      ...
      b.contextType = g.CurrencyContext;
      const f = b;
      var x = r(31511);
      class C extends a.Component {
        getChartMeta() {
          const { query: e } = this.props,
            t = 'compare-taxes' === e.filter ? 'item-comparison' : 'time-comparison';
          return { itemsLabel: (0, n.__)('%d taxes', 'woocommerce'), mode: t };
        }
        render() {
          const { isRequesting: e, query: t, path: r } = this.props,
            { mode: o, itemsLabel: s } = this.getChartMeta(),
            n = { ...t };
          return (
            'item-comparison' === o && (n.segmentby = 'tax_rate_id'),
            (0, a.createElement)(
              a.Fragment,
              null,
              (0, a.createElement)(x.Z, {
                query: t,
                path: r,
                filters: i.u8,
      ...
      C.propTypes = { query: s().object.isRequired };
      const v = C;
    },
    86806: (e, t, r) => {
      r.d(t, { I: () => o });
    ...
    20513: (e, t, r) => {
      ...
      d(l.NAMESPACE + '/products/attributes', e => ({ key: e.id, label: e.name }));
      const u = d(l.NAMESPACE + '/products/categories', e => ({ key: e.id, label: e.name })),
        p = d(l.NAMESPACE + '/coupons', e => ({ key: e.id, label: e.code })),
        y = d(l.NAMESPACE + '/customers', e => ({ key: e.id, label: e.name })),
        g = d(l.NAMESPACE + '/products', e => ({ key: e.id, label: e.name })),
        h = d(l.NAMESPACE + '/taxes', e => ({ key: e.id, label: (0, c.I)(e) }));
