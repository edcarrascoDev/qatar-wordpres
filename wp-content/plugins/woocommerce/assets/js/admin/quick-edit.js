...
jQuery(function($) {
  $('#the-list').on('click', '.editinline', function() {
    ...
    $('select[name="_stock_status"] ~ .wc-quick-edit-warning', '.inline-edit-row').toggle(
      is_variable_product,
    );
    $(
    ...
    $('select[name="_tax_status"] option[value="' + tax_status + '"]', '.inline-edit-row').attr(
      'selected',
      'selected',
    );
    $('select[name="_tax_class"] option[value="' + tax_class + '"]', '.inline-edit-row').attr(
      'selected',
      'selected',
    );
    $('select[name="_visibility"] option[value="' + visibility + '"]', '.inline-edit-row').attr(
      'selected',
      'selected',
    );
    $('select[name="_backorders"] option[value="' + backorders + '"]', '.inline-edit-row').attr(
      'selected',
      'selected',
    );
    ...
    if ('yes' === product_is_virtual) {
      ...
      $('.dimension_fields', '.inline-edit-row')
        .show()
        .removeAttr('style');
    }
