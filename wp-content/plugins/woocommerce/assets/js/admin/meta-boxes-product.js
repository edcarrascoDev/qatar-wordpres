...
jQuery(function($) {
  ...
  // Stock options.
  function show_or_hide_stock_management_fields(isStockManagementEnabled, productType) {
  ...
  $('input#_manage_stock')
    .on('change', function() {
      ...
      show_or_hide_stock_management_fields(isStockManagementEnabled, productType);
  ...
  $('.product_attributes .woocommerce_attribute').each(function(index, el) {
    ...
    if (
      ...
      $('.woocommerce_attribute input.woocommerce_attribute_used_for_variations').on(
        'change',
        function() {
          add_placeholder_to_attribute_values_field($(el));
        },
  ...
  $('.product_attributes').on('blur', 'input.attribute_name', function() {
    ...
    var $attribute = $inputElement.closest('.woocommerce_attribute').find('strong.attribute_name');
    if (text === '') {
      $attribute
  ...
  $('.product_attributes').on('click', 'button.add_new_attribute', function(event) {
  ...
  $(document.body).on(
    ...
    function() {
      $('#woocommerce-product-data .attribute_tab a[href="#product_attributes"]').trigger('click');
      return false;
    },
  );
  ...
  $('#wp-content-media-buttons')
    ...
    .attr('tabindex', '0')
    .attr('for', 'content')
    .attr('aria-label', woocommerce_admin_meta_boxes.i18n_product_description_tip)
    .tipTip({
      attribute: 'data-tip',
  ...
  $('#postexcerpt > .postbox-header > .hndle')
    ...
    .find('.woocommerce-help-tip')
    .attr('tabindex', '0')
    .attr('aria-label', woocommerce_admin_meta_boxes.i18n_product_short_description_tip)
    .tipTip({
      attribute: 'data-tip',
