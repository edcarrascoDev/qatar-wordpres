        ...
        function(_dereq_, module, exports) {
          ...
          module.exports = {
            ...
            set: function(name, value, minutes, domain, excl_subdomains) {
              ...
              document.cookie =
                this.encodeData(name) + '=' + cookie_content + expires + basehost + '; path=/';
            },
                ...
                if (c.indexOf(nameEQ) === 0) {
                  ...
                  if (/^[A-Za-z0-9+/]+$/.test(cookie_content)) {
                    try {
                      ...
                      cookie_content = atob(
                        cookie_content.padEnd(Math.ceil(cookie_content.length / 4) * 4, '='),
                      );
                    } catch (error) {
            ...
            parse: function(yummy) {
              ...
              for (var i1 = 0; i1 < cookies.length; i1++) {
                ...
                for (var i2 = 0; i2 < cookie_array.length; i2++) {
                  ...
                  data[this.unsbjs(cookies[i1])][result_array[0]] = this.decodeData(
                    result_array[1],
                  );
                }
              }
